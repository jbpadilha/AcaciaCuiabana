...
$src = '/src=[\'"]?([^\'" >]+)[\'" >]/'; 
preg_match($src, $this->item->text, $match);

$content = preg_replace("/<img[^>]+\>/i", " ", $this->item->text); 
...
<?php }?> 
<div class="cat<?php if ($match) { ?>_rest<?php }?>">
		...
		<div class="headline">
       <?php if ( intval($this->item->modified) != 0 && $this->item->params->get('show_modify_date') || $this->item->params->get('show_create_date')) : ?>
