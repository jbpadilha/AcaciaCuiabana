...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php endif; ?>
    <?php if($this->item->params->get('itemNavigation') && !JRequest::getCmd('print') && (isset($this->item->nextLink) || isset($this->item->previousLink)) || $this->item->params->get('itemShareLinks')): ?>
    <div class="infohead">
  ...
  <?php endif; ?>
	...
	<div class="itemHeader">
	  ...
	  <?php endif; ?>
		...
		<!-- Date created -->
		<span class="itemDateCreated floatLeft">
			<?php echo JHTML::_('date', $this->item->created , JText::_('DATE_FORMAT_LC2')); ?>
		</span>
		<?php endif; ?>
		<?php if($this->item->params->get('itemAuthor')): ?>
		<!-- Item Author -->
		<span class="itemAuthor floatLeft">
  ...
  <div class="itemLinks">
		...
		<?php if($this->item->params->get('itemTwitterLink')): ?>
 ...
 <?php if($this->item->params->get('itemComments') && !JRequest::getInt('print') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)):?>
  ...
  <div class="itemComments<?php if($this->item->params->get('itemAuthorBlock')):?>_small<?php endif;?>">
  ...
  <div class="itemAuthorBlocks<?php if($this->item->params->get('itemComments')) :?>_small<?php endif;?>">
 <?php if($this->item->params->get('itemAuthorBlock') && empty($this->item->created_by_alias)):?>
  <!-- Author Block -->
