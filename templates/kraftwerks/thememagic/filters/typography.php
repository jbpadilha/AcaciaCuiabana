...
class typography {
	...
	function set_diacritic_custom_replacements($customReplacements = null) {
		if(!is_array($customReplacements) AND !$customReplacements == null)  
		    $customReplacementChunks = array(); 
