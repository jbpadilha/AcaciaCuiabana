...
<html>
	<head>
		<script type="text/javascript">
			...
			{
				if ( $('#usuario').val() == '' ) {
					alert('O nome do usu�rio deve ser informado !');
					return false;
				}
				if ( $('#senha').val() == '' ) {
					alert('A senha do usu�rio deve ser informado !');
					return false;
				} 
				if ( $('#grupousuario').val() == '' ) {
					alert('O grupo de acesso do usu�rio deve ser informado !');
					return false;
				}
				if ( $('#nomepessoa').val() == '' ) {
					...
					var formulario = $('#usuarios').serialize(true);
					enviaFormulario($('#usuarios').attr("action"),'page',formulario);
				}
			}
			</script>	
	</head>
