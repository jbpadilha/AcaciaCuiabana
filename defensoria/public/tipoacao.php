...
<form name="tipoacao" id="tipoacao" method="post" action="../application/recebePostGet.php" onclick="cadastra()" >
	<?php
	$tipoacao = null;
	...
	<input type="hidden" id="function" name="function" value="<?=(isset($_GET['idTipoAcao']))?"alterar":"cadastrar"?>"/>
	...
	<table>
		<tr>
			...
			<td width="49"><input type="submit" name="submit" id="submit" value="<?=(isset($_GET['idTipoAcao']))?"Alterar":"Cadastrar"?>"/></td>
		</tr>
	</table>
</form>
<?php
