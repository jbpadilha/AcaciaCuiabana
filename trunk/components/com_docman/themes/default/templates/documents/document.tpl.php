...
<div id="dm_details" class="dm_doc">
	<div class="app-box-header"><div class="app-box-header">
		<h2 style="float:left; width:85%" class="app-box-title"><?php echo _DML_TPL_DETAILSFOR ?><em>&nbsp;<?php echo $this->data->dmname ?></h2>
	</div></div>    
...
<div class="app-box-footer no-border"><div class="app-box-footer no-border"></div></div></div>
