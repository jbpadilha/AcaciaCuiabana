		 ...
		 <tr>
						...
						<div class="app-box">
						  <div class="app-box-header">
							  <div class="app-box-header"><h2 class="app-box-title" style="text-align:center;">
							  	<?php
                    if (!$since) {
                    ...
                    ?><?php echo $lastvisit; ?> <?php echo _SHOW_HOURS; ?> (<?php echo _SHOW_POSTS; ?><?php echo $countRS; ?>)
							 </h2> </div>        
						  </div>						  						
					</div>		
					 ...
					 <div class="app-box-content">
					  ...
					  <div id="fb_topmenu" style=" margin-left:70px;">
