...
<div class="<?php echo $boardclass; ?>_bt_cvr5">
    <form action = "index.php" method = "post" name = "fbBulkActionForm">
        ...
        <table class = "fb_blocktable<?php echo $objCatInfo->class_sfx; ?>" id = "fb_flattable" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
			...
			<thead>
                <tr>
                    <th colspan = "<?php echo ($is_Moderator?"7":"6");?>" align="left">
						<div class="app-box-header">
						  <div class="app-box-header">
						  		<div style="float:left;">
									<h2 class="app-box-title"><span class = "fb_title fbl"><b><?php echo _KUNENA_THREADS_IN_FORUM; ?>:</b> <?php echo '' . kunena_htmlspecialchars(stripslashes($objCatInfo->name)) . ''; ?></span></h2>
								</div>
