<?php
/**
* @version $Id: showcat.php 1042 2009-08-27 05:58:01Z mahagr $
* Kunena Component
* @package Kunena
*
...
<div class="clear"></div><div class="app-box-contentonly"><div class="fb_forum-headerdesc"><?php
    ...
    <table border = "0" cellspacing = "0" class = "jr-topnav" cellpadding = "0">
        <tr>
            <td class = "jr-topnav-left">
                ...
                echo '</td><td align="right" class="jr-topnav-right">';
                ...
                if (count($messages[0]) > 0)
                {
                    ...
                    {
                        if ($page == $i) {
                            echo "<span class=\"jr-pagenav-nb-act\"> $i</span>";
                        }
                        else {
...
<div class="<?php echo $boardclass; ?>_bt_cvr5">
    <table class = "fb_blocktable"  id="fb_bottomarea" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
        ...
        <thead>
            <tr>
                <th colspan="2" class = "th-left" align="left" >
                        <?php
