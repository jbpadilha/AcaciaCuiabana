...
<form action="<?php echo JRoute::_(KUNENA_LIVEURLREL. '&amp;func=advsearch'); ?>" method="post" id="searchform" name="adminForm">    
        ...
        <thead>
            <tr>
                <th align="left" colspan="2">
					...
					<div class="app-box-header">
						<h2 class="app-box-title" style="float:left;"><?php echo _KUNENA_SEARCH_ADVSEARCH; ?></h2>
						<div style="float:right;"><img id="BoxSwitch__advsearch_main" class="hideshow" src="<?php echo $fb_advsearch_img ?>" alt=""/></div>
					</div>
					</div>         
                </th>
            </tr>
	...
	<tr><td colspan="2"><div class="app-box-footer"><div class="app-box-footer"></div></div></td></tr>
	<tr>
	<td colspan="2">
        ...
        <thead>
            <tr>
                <th align="left" colspan="2">                    
					<div class="app-box-header">
					<div class="app-box-header">
						<h2 class="app-box-title" style="float:left;"><?php echo _KUNENA_SEARCH_OPTIONS; ?></h2>
						<div style="float:right;"><img id="BoxSwitch__advsearch_options" class="hideshow" src="<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt=""/></div>
					</div>
					</div>  
                </th>
            </tr>
...
*/ ?>
		...
		<tr><td colspan="2"><div class="app-box-footer" style="margin-bottom:10px; "><div class="app-box-footer"></div></div></td></tr>
    </table>
    ...
    <table class="fb_list_bottom" width="100%" cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr><td>
				<div class="app-box-header">
				  <div class="app-box-header">						  
						  <div style="float:right; margin-top:10px;"><input class="fbs button" type="submit" value="<?php echo _KUNENA_SEARCH_SEND; ?>"/>
        			<input class="fbs button" type="reset" value="<?php echo _KUNENA_SEARCH_CANCEL; ?>" onclick="window.location='<?php echo JRoute::_(KUNENA_LIVEURLREL);?>';"/>				</div>
				  </div>     
 			    </div>			
				</td>
			</tr>
