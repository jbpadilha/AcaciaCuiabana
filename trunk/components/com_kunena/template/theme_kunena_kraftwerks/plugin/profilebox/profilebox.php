...
<div ><?php echo _PROFILEBOX_WELCOME; ?>, <b><?php echo $jr_username; ?></b></div>
				<div style="float:left;" id="fb_topmenu"><a href = "<?php echo $logoutlink;?>"><span><?php echo _PROFILEBOX_LOGOUT; ?></span></a></div>
</td>
			<?php
