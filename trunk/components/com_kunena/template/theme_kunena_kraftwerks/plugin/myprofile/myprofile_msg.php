		...
		<tr>
			<th colspan = "6">
				<div class="app-box-header">
					<div class="app-box-header">
						<div style="float:left;"><h2 class="app-box-title"><?php echo _KUNENA_USERPROFILE_MESSAGES; ?></h2></div>
						<div style="float:right;"><img id = "BoxSwitch_fbuserprofile__<?php echo $boardclass ;?>fbuserprofile_tbody" class = "hideshow" src = "<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt = "" /></div> 
					</div>        
				</div>								  				
            </th>
		</tr>
