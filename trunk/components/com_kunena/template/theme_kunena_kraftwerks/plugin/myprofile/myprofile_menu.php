		 ...
		 <tr>
            <th>
				<div class="app-box-header">
					  <div class="app-box-header">
					  	 <span class = "app-box-smalltitle"><?php echo _KUNENA_MYPROFILE_PERSONAL_INFO; ?></span>				
					  </div>        
				</div>		
...
?>
		...
		<tr><td class="clear" style="border:0px;"></td></tr>
		<tr>
            <th>
				<div class="app-box-header">
					  <div class="app-box-header">
					  	 <span class = "app-box-smalltitle"><?php echo _KUNENA_MYPROFILE_FORUM_SETTINGS; ?></span>				
					  </div>        
				</div>	
            </th>
        </tr>   
        ...
        <tr>
            <td class = "fb_myprofile_menu_staff">
                <a href = "<?php echo JRoute::_(KUNENA_LIVEURLREL . '&amp;func=myprofile&amp;do=showset'); ?>"><?php echo _KUNENA_MYPROFILE_LOOK_AND_LAYOUT; ?></a>
 ...
 //Clexus PM
    if ($fbConfig->pm_component == 'clexuspm' || $fbConfig->fb_profile == "clexuspm")
    {
       ?>
		...
		<tr>
            <th>
				<div class="app-box-header">
					  <div class="app-box-header">
					  	 <span class = "app-box-smalltitle"><?php echo _KUNENA_MYPROFILE_PRIVATE_MESSAGING; ?></span>				
					  </div>        
				</div>	
            </th>
        </tr>   
       ...
       <tr>
        ...
        </tr><tr><td class="clear" style="border:0px;"></td></tr>
<?php
    }
