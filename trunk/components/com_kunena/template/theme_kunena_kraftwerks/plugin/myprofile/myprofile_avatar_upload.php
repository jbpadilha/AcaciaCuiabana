             ...
             <thead><tr>
                <th colspan = "2">					
						  <div class="app-box-header">
							  <div class="app-box-header"><h2 class="app-box-title"><?php echo _YOUR_AVATAR; ?></h2>
							   </div>
							 </div>
            ...
            <tr>
                <td >
                    ...
                    ?>
                            ...
                            <div id="fb_topmenu"><a href = "<?php echo JRoute::_(KUNENA_LIVEURLREL.'&func=myprofile&do=avatar');?>"> <span><?php echo _SET_NEW_AVATAR; ?></span></a></div>
...
<table class = "fb_blocktable" id ="fb_forumua" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
            <thead>
                <tr>
                    <th>
						  <div class="app-box-header">
							  <div class="app-box-header"><h2 class="app-box-title"><?php echo _UPLOAD_SUBMIT; ?></span></h2>
							   </div>
							 </div>
					</th>
                </tr>
...
<?php
        ...
        echo '<div style="padding:10px;text-align:center;"><form action="' . JRoute::_(KUNENA_LIVEURLREL . '&func=myprofile&do=avatar&action=upload') . '" method="post" name="adminForm" enctype="multipart/form-data">';
...
<table class = "fb_blocktable" id ="fb_forumua_gal" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
            <thead>
                <tr>
                    <th>                      
						 <div class="app-box-header">
							  <div class="app-box-header"><h2 class="app-box-title"><?php echo _UPLOAD_GALLERY; ?></span></h2>
							   </div>
							 </div>
					</th>
                </tr>
