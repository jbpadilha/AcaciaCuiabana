...
<div class="app-box-header">
	<div class="app-box-header">
		<?php if ($this->params->def( 'show_page_title', 1 )) : ?><h2 style="float:left; width:80%" class="app-box-title"><?php echo $this->escape($this->pagetitle); ?>
    <?php echo ELOutput::editbutton($this->item->id, $this->venue->id, $this->params, $this->allowedtoeditvenue, 'editvenue' ); ?></h2><?php endif; ?>
