...
<div class="app-box-header">
	<div class="app-box-header">
		<?php if ($this->params->def( 'show_page_title', 1 )) : ?><h2 style="float:left; width:80%" class="app-box-title"><?php echo $this->params->get('page_title'); ?></h2><?php endif; ?>
...
<div class="app-box-content no-padding"><div class="app-box-info">
<!-- Details EVENT -->
	<h2 class="eventlist">
		<?php
    	echo JText::_( 'EVENT' );
