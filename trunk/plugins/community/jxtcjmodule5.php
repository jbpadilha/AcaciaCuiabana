<?php
/*
	JoomlaXTC jmodule5  plugin for JomSocial
...
if(!class_exists('plgCommunityjxtcjmodule5')) {
	class plgCommunityjxtcjmodule5 extends CApplications {
		var $name 		= "jmodule5";
		var $_name		= 'jmodule5';
		var $_path		= '';
		var $_user		= '';
		...
		function onProfileDisplay() {
			...
			$callback = array('plgCommunityjxtcjmodule5', '_buildHTML');
		...
		function _buildHTML($that) {
			$position = $that->params->get('position', 'jmodule5');
