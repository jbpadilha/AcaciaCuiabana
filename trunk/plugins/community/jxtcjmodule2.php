<?php
/*
	JoomlaXTC jmodule2  plugin for JomSocial
...
if(!class_exists('plgCommunityjxtcjmodule2')) {
	class plgCommunityjxtcjmodule2 extends CApplications {
		var $name 		= "jmodule2";
		var $_name		= 'jmodule2';
		var $_path		= '';
		var $_user		= '';
		...
		function onProfileDisplay() {
			...
			$callback = array('plgCommunityjxtcjmodule2', '_buildHTML');
		...
		function _buildHTML($that) {
			$position = $that->params->get('position', 'jmodule2');
