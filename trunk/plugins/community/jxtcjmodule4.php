<?php
/*
	JoomlaXTC jmodule4  plugin for JomSocial
...
if(!class_exists('plgCommunityjxtcjmodule4')) {
	class plgCommunityjxtcjmodule4 extends CApplications {
		var $name 		= "jmodule4";
		var $_name		= 'jmodule4';
		var $_path		= '';
		var $_user		= '';
		...
		function onProfileDisplay() {
			...
			$callback = array('plgCommunityjxtcjmodule4', '_buildHTML');
		...
		function _buildHTML($that) {
			$position = $that->params->get('position', 'jmodule4');
