...
define('TEXT_INFO_ZONES_NAME', 'Nome das Zonas:');
define('TEXT_INFO_ZONES_CODE', 'Códigos das Zonas:');
define('TEXT_INFO_COUNTRY_NAME', 'País:');
define('TEXT_INFO_INSERT_INTRO', 'Por favor introduza a nova Zona e informações relacionadas');
define('TEXT_INFO_DELETE_INTRO', 'Tem certeza que deseja apagar esta Zona?');
