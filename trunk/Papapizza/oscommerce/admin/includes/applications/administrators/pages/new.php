...
<div class="infoBoxContent">
  ...
  <fieldset>
	...
	<div><label for="user_fullname"><?php echo $osC_Language->get('field_fullusername'); ?></label><?php echo osc_draw_input_field('user_fullname'); ?></div>
    <div><label for="user_email"><?php echo $osC_Language->get('field_email'); ?></label><?php echo osc_draw_input_field('user_email'); ?></div>
    <div><label for="user_cell"><?php echo $osC_Language->get('field_cell'); ?></label><?php echo osc_draw_input_field('user_cell'); ?></div>
