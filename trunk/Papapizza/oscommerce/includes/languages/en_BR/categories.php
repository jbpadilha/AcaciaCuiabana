...
action_heading_new_category = Nova Categoria
action_heading_batch_delete_categories = Remover Grupo de Categorias
action_heading_batch_move_categories = Mover Grupo de Categorias

field_parent_category = Categoria Principal:
field_name = Nome :
field_image = Imagem :
...
introduction_new_category = Preencha a seguinte informação para a nova Categoria .

introduction_edit_category = Faça as mudanças necessárias para esta Categoria .

introduction_move_category = Selecione a Categoria Principal para que possa ser movida .

introduction_delete_category = Verifique a remoção desta categoria e de suas sub-categorias .
delete_warning_category_in_use_children = Aviso : Há sub-categorias de %s que serão removidas com ela. Você tem certeza de que é isso que quer fazer mesmo?
