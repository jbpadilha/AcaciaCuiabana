...
*/
  ...
  class osC_Payment_moneyorder extends osC_Payment_Admin {
    var $_title,
        $_code = 'moneyorder',
        $_author_name = 'escri2',
        $_author_www = 'http://www.pedroescribano.com',
        $_status = false,
        $_sort_order;
 ...
 */
    ...
    function isInstalled() {
      return (bool)defined('MODULE_PAYMENT_MONEYORDER_ORDER_STATUS_ID');
    }
