...
731717
#Kunena
a{text-decoration:none;font-weight:normal}#Kunena a:link, #Kunena a:visited{color:#666}#Kunena a:hover{color:#999}#Kunena
.fbxs{font-size:8px}#Kunena
.fbs{font-size:10px}#Kunena
.fbm{font-size:11px}#Kunena
.fbl{font-size:14px}#Kunena
.fbxl{font-size:18px}#Kunena
.fbxxl{font-size:28px}#Kunena
.fb_header{height:30px}#Kunena
.fb_header_th_1{padding:2px}td.fb_profileboxcnt{width:95%}#fb_topmenu,#fb_searchbox{height:46px;margin:0px;padding:0
0 0 0px}#fb_topmenu a, #fb_searchbox
a{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/toolbar-item-off-left.gif') no-repeat left top;float:left;line-height:27px;list-style-position:outside;list-style-type:none;padding:0
0;margin-left:0px;margin-right:3px;margin-top:11px;margin-bottom:0
text-decoration:none}#fb_topmenu a span, #fb_searchbox a
span{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/toolbar-item-off-right.gif') no-repeat right top;color:#999;display:block;text-decoration:none;padding-left:14px;padding-right:14px;padding-top:0;padding-bottom:0}#fb_topmenu a:hover, #fb_searchbox a:hover{text-decoration:none}#fb_topmenu a span:hover, #fb_searchbox a span:hover{color:#fff}#fb_searchbox{width:auto;white-space:nowrap}#fb_searchbox
form{margin:0;padding:0}#fb_searchbox
.fb_search_inputbox{width:auto;border:1px
solid #666;background:#FFF url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/search_icon.gif') no-repeat 5px center;font-weight:normal;margin-left:5px;margin-right:0;margin-top:0;margin-bottom:0;padding-left:20px;padding-right:5px;padding-top:2px;padding-bottom:2px}#fb_searchbox
.fb_search_button{margin:0
5px 0 0}.fb_search-results{color:#F00;font-weight:bold}#Kunena
table.fb_blocktable{width:100%;margin:5px
0 0 0;text-align:left;border-collapse:collapse}#Kunena table.fb_blocktable thead tr
th{font-color:#bcbcbc;font-weight:normal;margin-top:16px}#Kunena
div.fb_title_cover{float:left;text-align:left;font-size:14px;line-height:normal;padding-left:12px;padding-right:0;padding-top:8px;padding-bottom:0}#Kunena a.fb_title,
#Kunena
.fb_title{height:46px;line-height:46px;font-size:22px;font-weight:100;display:block;text-decoration:none;z-index:12}#Kunena
.fb_titlet{height:46px;font-size:22px;font-weight:100;display:block;text-decoration:none}#Kunena
img.hideshow{float:right;margin:17px
0px 0px 5px;padding:0;cursor:pointer;position:relative;z-index:1}#Kunena
tr.fb_sth{background:#fafafa;padding:6px}th.fb_sectiontableheader{border:1px
solid #eaeaea;padding:8px}#Kunena tr.fb_sectiontableentry1
td{background-color:#fafafa;padding:5px;border:1px
solid #eaeaea;border-collapse:collapse}#Kunena tr.fb_sectiontableentry2
td{background-color:#fff;padding:5px;border:1px
solid #eaeaea;border-collapse:collapse}#Kunena div.fb_thead-title
a{}div.fb_thead-desc{}#Kunena div.fb_thead-child{border-top:1px dotted #D4C9AD;margin-top:4px}#Kunena table.fb_cc-table tr
td{border:0px
solid #FFF}#Kunena div.fb_cc-childcat-title{width:90px;float:left}table.fb_cc-table{}tr.fb_cc-sectiontableentry1{}tr.fb_cc-sectiontableentry2{}span.fb_childcount{}#Kunena div.fb_latest-subject
a{font-weight:bold}div.fb_latest-subject-by{}span.newchar{color:#F60;font-weight:bold;font-family:TrebuchetMS,Arial,Helvetica,sans-serif;font-size:8px}#Kunena  a.fb-topic-title{font-weight:bold}#Kunena img.stickyicon,
#Kunena
img.attachicon{float:right;border:0px
none;margin:2px}#Kunena
img.catavatar{width:20px;height:20px;margin-left:4px;border:1px
solid #CCC}.fb_contentheading{background:#ECE9D8;font-weight:bold;color:#900;border-bottom:3px solid #DDD5BF;border-left:1px solid #CCC;border-right:1px solid #CCC;border-top:1px solid #FFF}.fb_contentheading
span{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/spoticon.gif') no-repeat left center;padding-left:16px}.fb_sectiontableentry1_stickymsg{background:#FFFFCE}.fb_sectiontableentry2_stickymsg{background:#FFFFE6}tr.fb_sectiontableentry1_stickymsg td,
tr.fb_sectiontableentry2_stickymsg
td{border-bottom:1px solid #CCC;border-left:1px solid #FFF;border-right:1px solid #CCC;padding:2px}tr.fb_sectiontableentry1_stickymsg td.td-1,
tr.fb_sectiontableentry2_stickymsg td.td-1{border-left:1px solid #CCC}#fb_views{}th.view-th{text-align:right;padding-right:10px}th.fb_sectiontableheader{border-left:1px solid #e3e3de}td.fb-msgview-left{vertical-align:top;width:170px;border-bottom:1px solid #e3e3de;border-left:1px solid #e3e3de}td.fb-msgview-right{background:fff;border-left:1px solid #e3e3de;padding:5px
10px 5px 30px;vertical-align:top;border-right:1px solid #e3e3de;border-bottom:1px solid #e3e3de}div.fb-msgview-l-cover{background:fff;border-left:1px solid #e3e3de;overflow:auto;text-align:center;padding:5px}span.view-username{}span.view-username a:link,
span.view-username a:visited{font-weight:bold;text-decoration:none;color:#357994}span.view-username a:hover{color:#000;text-decoration:none}span.msgusertype{font-weight:normal;text-decoration:none;text-decoration:none;font-style:italic}span.fb_avatar{}span.fb_avatar
img{border:1px
solid #CCC;padding:1px;margin:5px}div.viewcover{border:1px
solid #CCC;background:#f4f4f4;color:#333;text-align:center;margin:2px
5px}span.msgtitle,span.msgtitle_new{font-weight:bold;text-decoration:none;background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/msgtitleicon.gif') no-repeat left center;padding-left:25px;line-height:26px}span.msgtitle_new{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/msgtitleicon.gif') no-repeat left center}span.msgdate{font-weight:normal;text-decoration:none;padding-left:10px}span.msgkarma{font-weight:bold;color:#333;text-decoration:none;padding-right:10px}div.msgtext{overflow:hidden}div.fbcode{overflow:auto}div.msgtext pre, div.msgtext
.code{border-left:5px solid #F4A94F;border-right:1px solid #CCC;border-top:1px solid #CCC;border-bottom:1px solid #CCC;font-family:"Courier News",monospace;font-size-adjust:none;font-stretch:normal;font-style:normal;font-variant:normal;font-weight:normal;line-height:1.5;margin:5px
0pt 15px;padding:10px
15px;width:100%;overflow:auto}div.fb_file_attachment{background:#FFDDD5;padding:10px;margin-bottom:10px}span.contentheading{}div.switchcontent{}input.fb_qm_btn{}input.fb_qm_cncl_btn{}td.fb-msgview-left-c{background:#fff;vertical-align:top;border-left:1px solid #e3e3de;border-bottom:1px solid #e3e3de}td.fb-msgview-right-c{background:#fff;padding:1px
5px 1px 5px;vertical-align:top;border-right:1px solid #e3e3de;border-bottom:1px solid #e3e3de}div.fb_smalltext{}td.fb-msgview-right-c
div.fb_smalltext{padding:5px;text-align:right}div.fb_message_editMarkUp_cover{padding-top:5px;text-align:right}span.fb_message_editMarkUp{background:#f7f7f7 url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/edit.gif') no-repeat left center;border-left:1px dotted #999;border-right:1px dotted #999;border-top:1px dotted #999;font-size:9px;color:#666;padding-left:20px;padding-right:5px;padding-top:2px;padding-bottom:2px}div.msgsignature{border-top:dotted 1px #ccc;text-align:left;color:#999;padding-top:10px}td.fb-msgview-left-b{background:#fff;vertical-align:top;width:170px;border-bottom:1px solid #ccc;border-left:1px solid #e3e3de;padding:5px}td.fb-msgview-right-b{border-bottom:1px solid #ccc;padding:1px
5px 1px 5px;vertical-align:top;border-right:1px solid #e3e3de;padding:5px}span.fb_qr_fire{}.switchcontent{display:none}span.fb_quote{display:block;border:1px
dotted #CCC;margin:5px
0pt;padding:5px;font-family:Arial,Helvetica,sans-serif;font-style:italic;background:#F7F7F7}#Kunena
div.fbhide{background:#FFF8F2 url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/bullet-tips.gif') no-repeat 5px center;border:1px
dotted #F2CAB7;font-size:12px;padding-left:25px;padding-right:10px;padding-top:10px;padding-bottom:10px}#fb_threadview{border:1px
solid #CCC}div#fb_threadview
table.fb_blocktable{margin:0}.fb_threadview_row
td{border-top:1px  dotted #CCC}.fb_threadview_row td table tr
td{border-top:0px solid #CCC}#fb_postmessage{border-left:1px solid #CCC;border-right:1px solid #CCC}table#fb_postmessage
.fb_button{border:1px
solid #999;color:#000;padding:1px}table#fb_postmessage
.fb_slcbox{border:1px
solid #999;color:#000}#fb_post_message
.postinput{width:94%;border:1px
solid #ccc;padding:3px
5px}#fb_postmessage tr.fb_sectiontableentry2 td.fb-topicicons
td{border-bottom:0px solid #CCC}#fb_postmessage tr.fb_sectiontableentry1 .fb-postbuttonset
td.fb_posthint{background:#FFC;border:1px
solid #CFC1A9;padding:2px
5px}table#fb_postmessage .fb_posthint
.fb_inputbox{background:#FFC;border:0px
solid #FFC;width:100%}.fb-postbuttonset{width:95%}.fb-postbuttons{}table#fb_postmessage
.fb_txtarea{width:95%;overflow:auto;height:300px;border:1px
solid #ccc}.fb_txtarea{height:300px;width:95%}#fb_postmessage tr.fb_sectiontableentry1 .fb-postbuttonset td,
#fb_postmessage tr.fb_sectiontableentry2 .fb-postbuttonset
td{border-bottom:0px solid #CCC}table#fb_postmessage
.button{border:1px
solid #999;color:#333;font-weight:bold;padding:3px
10px;margin:3px}.fb_leftcolumn{width:160px;text-align:right}img.fb-bbcode{cursor:pointer;margin-top:4px;margin-right:1px;padding:0px}img.fb-bbcode:hover{background-color:#e4e4e4;cursor:pointer;margin-top:4px;margin-right:1px;padding:0px}.fb-color_table{cursor:pointer;width:100%;margin-left:auto;margin-right:auto}#Kunena table.fb-postbuttonset tr td.fb-postbuttons
select.fb_slcbox{position:relative;bottom:5px}.fb_review_table{text-align:left;border-spacing:1px;background:#CCC}.fb_review_header{color:#fff}.fb_review_body0{color:#404040;background-color:#FFC;line-height:100%;padding:3px
10px}.fb_review_body1{color:#404040;background-color:#FFF;padding:3px
10px;line-height:140%}.fb_review_quote{padding:5px;border:dotted 1px #ccc;background-color:#FFF;color:#999;display:block}.fb_forum-pathway{background:#fff;padding:3px;margin:0px
0 0px 0;border-left:1px solid #EAEAEA;border-right:1px solid #EAEAEA}.path-element-first{font-weight:normal;height:18px;line-height:18px;padding-left:22px;background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/pathway_start.gif') no-repeat left center;float:left;padding-right:3px}.path-element-first a:link,
.path-element-first a:visited{font-weight:normal;text-decoration:none;background:none}.path-element-last,
.path-element-last a:link{font-weight:bold;text-decoration:none;text-indent:5px;clear:left;float:left}.fb_forum-pathway .path-element{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/arrow.png') no-repeat left center;padding-left:12px;float:left;font-weight:normal;height:18px;line-height:18px;padding-right:3px}.fb_forum-pathway .path-element-last{height:18px;line-height:18px;background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/pathway_finallink.gif') no-repeat left center;padding-left:30px;padding-right:5px}.path-element-users{margin-top:21px}table.jr-topnav{width:100%;padding:5px
0 5px 0}table.jr-bottomnav{width:100%}td.jr-topnav-left{text-align:left;width:70%;vertical-align:middle}td.jr-topnav-right{text-align:right;width:30%;vertical-align:middle}div.jr-pagenav{}div.jr-pagenav
ul{list-style:none;margin:0;padding:0;float:right}div.jr-pagenav ul
li{list-style:none;margin:0;padding:0
4px;display:block;float:left;background:none}div.jr-pagenav ul li.jr-pagenav-text{font-weight:normal;list-style:none;margin:0;padding:0
4px;display:block;float:left}a.jr-pagenav-nb:link,a.jr-pagenav-nb:visited{font-weight:bold;text-decoration:none}a.jr-pagenav-nb:hover{text-decoration:underline}li.jr-pagenav-nb span.pagenav, li.jr-pagenav-nb a.pagenav:link, li.jr-pagenav-nb a.pagenav:visited{font-weight:normal;text-decoration:none;background:none;border:0px;line-height:normal;margin:0;padding:0}.fb_bottom_pathway{display:none}#fb_ft-cover{position:relative;float:right;text-align:right}table.jr-ft{width:100%}td.ft-td1{width:100%}td.ft-td2{width:150px}#forumtools_control{width:150px}.forumtools_contentBox{border:1px
solid #CCC;display:none;position:absolute;right:0px;background:#000;overflow:hidden;width:150px}.forumtools_content{position:relative;width:100%;text-align:left;padding:1px}#subBox1
ul{margin:0;padding:0;list-style:none}#subBox1 ul
li{margin:0;padding:0;list-style:none;padding:3px
5px;color:#FFF;background:none}#subBox1 ul li a:link, #subBox1 ul li a:visited{color:#FFF;text-decoration:none;font-weight:normal;list-style:none}#subBox1 ul li a:hover{text-decoration:underline}a.forumtools:link,a.forumtools:visited{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/menu_open.gif') no-repeat right center;padding-right:20px;color:#FFF;font-size-adjust:none;font-style:normal;font-variant:normal;font-weight:bold;line-height:normal;text-align:center;text-decoration:none}a.forumtools:hover{text-decoration:underline}td.fb_faqdesc,td.fb_rulesdesc,td.fb_uadesc,td.fb_anndesc,td.fb_creditsdesc{vertical-align:top;padding:5px;border-bottom:1px solid #e3e3e3;border-left:1px solid #e3e3e3;border-right:1px solid #e3e3e3;background:#FFF}.fb_credits_intro{padding:10px
0 10px 0}.fb_team{margin:0;padding:0;border-top:1px solid #ddd}.fb_teammember{padding:7px
10px 7px 10px;border-bottom:1px solid #ddd;list-style:inside;margin:0}.fb_credits_more{padding:10px
0 10px 20px}.fb_profile-left{padding-right:5px}.fb_profile-right{}.fb_profileinfo{background:#fff;border-left:1px solid #CCC;border-right:1px solid #e3e3e3}.fb-usrprofile-misc{text-align:center;margin:0
auto}#fb_userprfmsg td.td-6{border-right:1px solid #e3e3e3}.fb_profile-bottomnav{background:#fff;border-left:1px solid #e3e3e3;border-right:1px solid #e3e3e3;padding:5px}.fb_myprofile_menu
td{border-left:1px solid #E3E3E3;border-right:1px solid #E3E3E3}.fb_myprofile_menu
a{display:block;padding:2px
5px 3px 10px;text-decoration:none}.fb_myprofile_menu a:hover{text-decoration:underline}.fb_myprofile_menu_title{font-weight:bold}.fb_myprofile_menu_staff{padding:5px
10px;border-bottom:4px solid #E3E3E3;margin-bottom:5px}.fb_myprofile_general{border-collapse:collapse}.fb_myprofile_general
td{padding:5px
5px;border-left:1px solid #E3E3E3;border-right:1px solid #E3E3E3}#Kunena
a.fbrecent{font-weight:bold}#Kunena
.fbgrouplist{padding:5px}.fb_credits{position:relative;text-align:center}.fb_footer{text-align:center}img.rsslink{position:absolute;right:3px;top:0px}.app-box{margin:0px
0px 0px 0px;padding:0px}.app-box-header{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/box-header.png') no-repeat scroll 0 0;background-position:left top;height:46px;padding-left:10px;margin-right:14px;position:relative}.app-box-header .app-box-header{background-position:right top;background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/box-header-right.png') no-repeat scroll right 0;padding:0px
10px 0px 0px;margin-right:-14px}.app-box-content{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/app-box-filerlink.png') no-repeat 0 0;border-left:1px solid #E3E3E3;border-right:1px solid #E3E3E3;padding:10px;background-color:#fff}.app-box-contentonly{background:url('/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/app-box-filerlink.png') no-repeat 0 0;border:1px
solid #E3E3E3;padding:10px;font-size:11px;background-color:#fff}.app-box-footer{background:url("/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/box-footer.png") repeat scroll 0 0 transparent;height:47px;padding-left:10px;color:#666;border:medium none;margin-right:14px}.app-box-footer .app-box-footer{background:url("/ligante3/components/com_kunena/template/theme_kunena_kraftwerks/images/box-footer-right.png") no-repeat scroll right top transparent;height:37px;padding-left:0;padding-right:10px;padding-top:10px;padding-bottom:0;margin-right:-14px}.app-box-title, .app-box-title
a{color:#666;font-size:22px;font-weight:100;line-height:46px;margin:0}.app-box-smalltitle, .app-box-smalltitle
a{color:#666;font-size:13px;font-weight:100;line-height:46px;margin:0;height:46px;font-weight:bold}.app-box-subtitle, .app-box-subtitle
a{color:#666;font-size:13px;font-weight:100;line-height:26px;margin:0;height:26px;font-weight:bold}.app-box-title a:hover{color:#999;font-size:22px;font-weight:100;line-height:46px;margin:0}.clear{height:5px;width:100%}
...
.cbOverlay{background-color:#000}.cbContainer{padding:5px;background-color:white;border:2px
solid gray}.cbBox
h3{font-size:1.4em;margin-top:0px;padding-top:3px;vertical-align:middle;text-align:center;background-color:#ccc;background-image:url(/ligante3/components/com_virtuemart/js/mootools/header-background.png)}.cbBox
p{margin:3px}.cbBox,.cbButtons{text-align:center}.cbButton{margin:3px}.cbCloseButton{background:url(/ligante3/components/com_virtuemart/js/mootools/close.gif) no-repeat;width:16px;height:16px;position:absolute;top:9px;right:5px;cursor:pointer}