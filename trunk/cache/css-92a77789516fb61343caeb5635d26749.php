...
.showcasefx_box
table{}.jxtcpopup{position:absolute;float:left;top:0;left:0;margin:0px
auto 0px auto;padding:5px;z-index:99999;border:none;background:none}.jxtcinner{width:620px}.jxtcpopupclose{position:absolute;height:69px;width:15px;margin:0;padding:4px
6px 0px 6px;font-size:0px;font-weight:bold;color:#FFF;top:58px;right:113px;cursor:pointer;background:url('/ligante3/modules/mod_jxtc_newspro/images/close.gif') no-repeat}.jxtcpopupdrag{position:absolute;height:69px;width:15px;margin:0;padding:4px
6px 0px 6px;font-size:0px;color:#FFF;top:138px;right:113px;cursor:pointer;background:url('/ligante3/modules/mod_jxtc_newspro/images/drag.gif') no-repeat}.tip{display:none}
...
.jxtcpopup{position:absolute;float:left;top:0;left:0;margin:0px
auto 0px auto;padding:5px;z-index:99999;border:0px
solid #d1d1d1;background:none}.jxtcinner{width:620px}.jxtcpopupclose{position:absolute;height:69px;width:15px;margin:0;padding:4px
6px 0px 6px;font-size:0px;font-weight:bold;color:#FFF;top:58px;right:113px;cursor:pointer;background:url('/ligante3/modules/mod_jxtc_vmshowcase/images/close.gif') no-repeat}.jxtcpopupdrag{position:absolute;height:69px;width:15px;margin:0;padding:4px
6px 0px 6px;font-size:0px;color:#FFF;top:138px;right:113px;cursor:pointer;background:url('/ligante3/modules/mod_jxtc_vmshowcase/images/drag.gif') no-repeat}.tip{display:none}.pop{display:none}

/*** modal.css ***/

.body-overlayed embed, .body-overlayed object, .body-overlayed
select{visibility:hidden}#sbox-window embed, #sbox-window object, #sbox-window
select{visibility:visible}#sbox-overlay{position:absolute;background-color:#000}#sbox-window{position:absolute;background-color:#000;text-align:left;overflow:visible;padding:10px;-moz-border-radius:3px}* html #sbox-window{top:50% !important;left:50% !important}#sbox-btn-close{position:absolute;width:30px;height:30px;right:					-15px;top:					-15px;background:url(/ligante3/media/system/images/closebox.png) no-repeat top left;border:none}.sbox-loading #sbox-content{background-image:url(/ligante3/media/system/images/spinner.gif);background-repeat:no-repeat;background-position:center}#sbox-content{clear:both;overflow:auto;background-color:#fff;height:100%;width:100%}.sbox-content-image#sbox-content{overflow:visible}#sbox-image{display:block}.sbox-content-image
img{display:block}.sbox-content-iframe#sbox-content{overflow:visible}

/*** wall.css ***/

.jxtcpopup{position:absolute;float:left;top:0;left:0;margin:0px
auto 0px auto;padding:5px;z-index:99999;border:0px
solid #d1d1d1;background:transparent}.jxtcinner{width:620px}.jxtcpopupclose{position:absolute;height:69px;width:15px;margin:0;padding:4px
6px 0px 6px;font-size:0px;font-weight:bold;color:#FFF;top:58px;right:113px;cursor:pointer;background:url('/ligante3/modules/mod_jxtc_seyretwall/images/close.gif') no-repeat}.jxtcpopupdrag{position:absolute;height:69px;width:15px;margin:0;padding:4px
6px 0px 6px;font-size:0px;color:#FFF;top:138px;right:113px;cursor:pointer;background:url('/ligante3/modules/mod_jxtc_seyretwall/images/drag.gif') no-repeat}.tip{display:none}