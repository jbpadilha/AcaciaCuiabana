...
img{border:0px
none}.clr{clear:both}#dm_header{height:25px;text-align:center}#dm_pathway{font-size:11px;text-align:left;background:#ddd;margin-bottom:5px;padding:3px
3px 3px 10px}h2{padding-left:10px;text-align:left}#dm_cats,#dm_docs{text-align:left}#dm_docs
h3{}#dm_docs
h3{margin-bottom:0}#dm_docs h3 span,
#dm_cats h3
span{display:block;float:right;margin: -15px 5px 0 0;font-size:11px;font-weight:normal}.dm_separator{border-top:1px solid gray}a.dm_icon,a.dm_thumb{float:left;padding-right:10px}a.dm_name{display:block;margin-top:3px;padding:8px
0 6px 5px;font-weight:bold;font-size:14px}a.dm_name:hover{background:#FC0;color:#FC6401}span.dm_new,span.dm_hot{padding-left:10px;color:black;font-weight:normal;font-style:italic}.dm_date,.dm_counter{float:right;margin:7px
5px 0 0}.dm_description{background-color:#EEE;padding:5px}.dm_homepage{padding:1px
1px 1px 5px;font-size:10px;background-color:#F8F8F8}.dm_cat{padding:3px}.dm_cat
.dm_name{font-size:20px;font-weight:bold;color:#666;margin-bottom:5px}.dm_cat
.dm_description{padding:3px;float:left}.dm_cat
.dm_thumb{float:left;margin-right:5px}.dm_cat
.dm_name_desc{float:left}.dm_unpublished{border:1px
dotted red;background-color:#FCC}.dm_unapproved{border:1px
dotted green;background-color:#CFC}.dm_checked_out{border:1px
dotted blue;background-color:#CCF}.dm_license{}.dm_license_agree{}.dm_orderby{margin:0
0 10px 0;padding:1px
1px 1px 10px;font-size:10px}.dm_doc caption, #dm_tooltip
caption{margin:auto;padding:5px
0 5px 0;font-weight:bold}.dm_doc table, #dm_tooltip
table{border-top:1px solid gray;border-left:1px solid gray;border-collapse:collapse}.dm_doc td, #dm_tooltip
td{border-right:1px solid gray;border-bottom:1px solid gray}.dm_doc thead, #dm_tooltip
thead{background-color:#FC0;font-weight:bold}.dm_doc
col#prop{background-color:#EEE}.dm_doc thead td, #dm_tooltip thead
td{text-align:left}#dm_details{clear:left;width:100%;text-align:left;float:left}#dm_details
table{width:100%}#dm_details td, #dm_details
thead{padding:5px}#dm_tooltip td, #dm_tooltip
thead{padding:2px}.dm_taskbar{padding-bottom:6px;margin-bottom:6px;font-family:arial;list-style-type:none}.dm_taskbar
li{float:left;list-style-type:none;background-image:url('/ligante3/components/com_docman/themes/default/css/none');font-size:10px;margin-left:0;margin-right:0;margin-top:0.5em;margin-bottom:2px;padding-left:3px;padding-right:0;padding-top:0;padding-bottom:0}.dm_taskbar li
a{display:block;padding-left:3px;padding-right:3px}.dm_taskbar li a:link,
.dm_taskbar li a:visited,
.dm_taskbar li a:hover{color:#696969;background-color:#eee;text-decoration:none}.dm_taskbar li a:link,
.dm_taskbar li a:visited{border-top:1px solid #cecece;border-bottom:1px solid Gray;;border-left:1px solid #cecece;border-right:1px solid Gray;}.dm_taskbar li a:hover{border-bottom:1px solid #cecece;border-top:1px solid Gray;border-right:1px solid #cecece;border-left:1px solid Gray}.dm_taskbar li.approve a:link{background-color:#CFC}.dm_taskbar li.publish a:link{background-color:#FCC}.dm_taskbar li.checkin a:link{background-color:#CCF}.dm_toolbar{list-style:none;height:32px;margin-right:25px}.dm_toolbar
li{float:right;background-image:url('/ligante3/components/com_docman/themes/default/css/none')}.dm_toolbar
.dm_btn{text-indent: -5000px;height:32px;width:32px;display:block}.dm_toolbar
#dm_btn_save{background-image:url('/ligante3/components/com_docman/themes/default/images/save.png')}.dm_toolbar
#dm_btn_cancel{background-image:url('/ligante3/components/com_docman/themes/default/images/cancel.png')}.dm_toolbar #dm_btn_save:hover{background-image:url('/ligante3/components/com_docman/themes/default/images/save-over.png')}.dm_toolbar #dm_btn_cancel:hover{background-image:url('/ligante3/components/com_docman/themes/default/images/cancel-over.png')}.dm_form{width:35em;border:1px
solid #cecece}.dm_form
fieldset{border:none;margin:0;padding:0}.dm_form
label{width:100px;font-weight:bold}.dm_form
label.nofloat{float:none}.dm_form
p{text-align:left}.dm_form
fieldset.dm_button{border-top:1px solid Gray}.dm_form select
option.label{background-color:#EEE;border:1px
solid #DDD;color:#333}.dm_form
.editor{float:none}#dm_frmupload
label{width:100px;padding-right:10px}#dm_frmupload
#dm_btn_back{float:left}#dm_frmupload
#dm_btn_submit{float:right}#dm_frmedit{width:90%;border:0px
none}#dm_frmedit
#dmthumbnail_preview{float:right;margin-right:30px;height:80px;width:80px;padding:3px;border:1px
solid silver}#dm_frmedit #license-page
label{width:250px}#dm_nav{clear:both;padding-top:15px;margin-top:15px;border-top:2px dotted #ddd}#dm_nav
div{margin-top:10px}.app-box{width:100%;margin-bottom:15px;display:inline-block}.app-box-header{background:url('/ligante3/components/com_docman/themes/default/images/box-header.png') no-repeat scroll 0 0;background-position:left top;height:46px;padding-left:10px;margin-right:14px;position:relative}.app-box-header .app-box-header{background-position:right top;background:url('/ligante3/components/com_docman/themes/default/images/box-header-right.png') no-repeat scroll right 0;padding:0px
10px 0px 0px;margin-right:-14px}c.no-background,
.app-box-header.no-background .app-box-header{background:none;padding:0}.app-box-title, h2.app-box-title
a{color:#789539;font-weight:bold;line-height:30px;background:none;margin:0;padding-top:6px}.app-box-menus{position:absolute;top:0;right:0;margin:8px}.app-box-menu{float:right;cursor:pointer;margin-left:5px}.app-box-menu-title{display:block;text-indent: -9999px}.app-box-menu-icon{background-image:url('/ligante3/components/com_docman/themes/default/images/app-box-menu-icon.png');background-repeat:no-repeat;margin-top:10px;height:16px;width:16px;line-height:0;display:block}.app-box-menu-icon:focus{outline:none}.app-box-menu.options .app-box-menu-icon{background-position:0 0}.app-box-menu.toggle .app-box-menu-icon{background-position: -16px 0}.app-box.collapse .app-box-menu.toggle .app-box-menu-icon{background-position: -32px 0}.app-box-content{background:url('/ligante3/components/com_docman/themes/default/images/app-box-filerlink.png') no-repeat;border:1px
solid #e3e3e3;padding:0px;position:relative;background-color:#fff}.app-box-content.no-padding{padding:12px
0 12px 0}.app-box-info{position:relative;padding:12px}.app-box-info
h3{font-size:16px;font-weight:bold;padding:0.5em 0 0.5em 0;margin:0.8em 0 0 0}.app-box-info h3
a{font-weight:bold}.app-box-info h3
span{color:#666;font-size:12px;font-weight:bold}.app-box-info
h2{font-size:1.2em;font-weight:bold;border-top:1px solid #e3e3e3;padding:0.5em 12px 0.5em 12px;margin:0.8em 0 0 0}.app-box-shadow{background:url('/ligante3/components/com_docman/themes/default/images/app-box-filerlink.png') no-repeat}.app-box-shadow-border{border-bottom:1px solid #e3e3e3;background:url('/ligante3/components/com_docman/themes/default/images/app-box-filerlink.png') no-repeat;height:20px;padding:10px}.app-box-shadow-border
h3{font-size:14px;font-weight:bold}.app-box-shadow-border h3
a{font-size:14px;font-weight:bold}.app-box-actions{text-align:right}.app-box-header .app-box-actions{padding:14px
0 0 0;float:right}.app-box-header+.app-box-actions.no-border{padding:4px
0 0;border:none}.app-box-action{padding:0
0px;outline:none}.app-box-action+.app-box-action{border-left:1px solid #AAA}.app-box-action.no-border{border:none}.app-box-action.active{font-weight:700}.app-box-footer{background:url("/ligante3/components/com_docman/themes/default/images/box-footer.png") repeat scroll 0 0 transparent;height:47px;padding-left:10px;color:#666;border:medium none;text-align:right;margin-right:14px}.app-box-footer .app-box-footer{background:url("/ligante3/components/com_docman/themes/default/images/box-footer-right.png") no-repeat scroll right top transparent;height:37px;padding-left:0;padding-right:10px;padding-top:10px;padding-bottom:0;margin-right:-14px}.app-box-footer.no-border{border:none}.clr{clear:both;height:5px;overflow:hidden}#component-com_docman
.box_left_title{background:url(/ligante3/components/com_docman/themes/default/images/component_head-round.png) no-repeat scroll 0 0;margin-right:14px;height:55px}#component-com_docman
.box_right_title{background:url(/ligante3/components/com_docman/themes/default/images/component_head-round-right.png) no-repeat scroll right 0;height:55px;margin-right:-14px}#component-com_docman .box_right_title
.pagetitle{font-size:20px;padding:20px
0 0 15px}div.buttonlink a.active-state,  div.bottonGroup a.active-state{color:#666;text-decoration:none}div.buttonlink a.active-state .Button,  div.bottonGroup a.active-state
.Button{float:left;font-family:Verdana;font-size:11px;height:24px;display:table}div.buttonlink a.active-state .Button DIV.ButtonLeft,  div.bottonGroup a.active-state .Button
DIV.ButtonLeft{float:left;background-image:url('/ligante3/components/com_docman/themes/default/images/home-btn-on-lft.gif');height:26px;width:8px;background-repeat:no-repeat;margin-left:5px;cursor:pointer;background-position-y:50%}div.buttonlink a.active-state .Button DIV.ButtonRight,  div.bottonGroup a.active-state .Button
DIV.ButtonRight{float:left;background-image:url('/ligante3/components/com_docman/themes/default/images/home-btn-on-rgt.gif');height:26px;width:8px;background-repeat:no-repeat;cursor:pointer;background-position-y:50%}div.buttonlink a.active-state .Button DIV.ButtonMiddle,  div.bottonGroup a.active-state .Button
DIV.ButtonMiddle{color:#fff;font-family:Verdana;font-size:11px;float:left;background-image:url('/ligante3/components/com_docman/themes/default/images/home-btn-on-bg.gif');height:25px;background-repeat:repeat-x;text-align:center;cursor:pointer;padding-top:1px}div.buttonlink a.active-state .Button p.TextBg,  div.bottonGroup a.active-state .Button
p.TextBg{float:left;color:#FFF;text-align:center;font-family:Verdana;font-size:11px;background-image:url('/ligante3/components/com_docman/themes/default/images/home-btn-on-arrow.gif');background-repeat:no-repeat;background-position:center bottom;height:26px}div.buttonlink a.active-state .Button p.Text,  div.bottonGroup a.active-state .Button
p.Text{float:left;color:#FFF;text-align:center;font-family:Verdana;font-size:11px;height:26px}div.buttonlink a,  div.bottonGroup
a{color:#666;text-decoration:none}div.buttonlink a .Button,  div.bottonGroup a
.Button{float:left;font-family:Verdana;font-size:11px;height:24px;display:table}div.buttonlink a .Button DIV.ButtonLeft,  div.bottonGroup a .Button
DIV.ButtonLeft{float:left;background-image:url('/ligante3/components/com_docman/themes/default/images/home-btn-off-lft.gif');height:26px;width:8px;background-repeat:no-repeat;margin-left:5px;cursor:pointer;background-position-y:50%}div.buttonlink a .Button DIV.ButtonMiddle,  div.bottonGroup a .Button
DIV.ButtonMiddle{float:left;background-image:url('/ligante3/components/com_docman/themes/default/images/home-btn-off-bg.gif');height:25px;background-repeat:repeat-x;text-align:center;cursor:pointer;background-position-y:50%;padding-top:1px}div.buttonlink a .Button DIV.ButtonRight,  div.bottonGroup a .Button
DIV.ButtonRight{float:left;background-image:url('/ligante3/components/com_docman/themes/default/images/home-btn-off-rgt.gif');height:26px;width:8px;background-repeat:no-repeat;cursor:pointer;background-position-y:50%}div.buttonlink a .Button p.TextBg,  div.bottonGroup a .Button
p.TextBg{text-align:center;font-family:Verdana;font-size:11px;height:26px}div.buttonlink a .Button p.Text,  div.bottonGroup a .Button
p.Text{text-align:center;font-family:Verdana;font-size:11px;height:26px}
...
td{border:0
none}.jpane-toggler
span{background:transparent url(/ligante3/components/com_docman/themes/default/images/j_arrow.png) 5px 50% no-repeat;padding-left:20px}.jpane-toggler-down
span{background:transparent url(/ligante3/components/com_docman/themes/default/images/j_arrow_down.png) 5px 50% no-repeat;padding-left:20px}.jpane-toggler-down{border-bottom:1px solid #ccc}dl.tabs{float:left;margin:10px
0 -1px 0;z-index:50}dl.tabs
