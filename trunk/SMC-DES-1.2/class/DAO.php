...
class DAO
{
	...
	*/
	...
	public function cadastrarMaquinas(Maquinas $maquinas)
	{
		$conecta = new Connecta();
		$valueObj = (object)$maquinas;
		$idMaquinas = '';
		$dataCadastro = '';
		$idCliente = '';
		$nomeMaquina = '';
		...
		try 
		{
			$sql = mysqli_prepare($conecta,"INSERT INTO dbmaquinas  
			VALUES ('', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,	?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
			?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
			
			mysqli_bind_param($sql,'ssssssssssssssssssssssssssssssssssssssssssssssssss', 
			$dataCadastro, $idCliente,$nomeMaquina,$numeroSerieMaquina, $fabricanteMaquinas,          
			$origemMaquinas,$origemPaisMaquinas, $modeloMaquinas, $numeroChassiMaquinas, $anoFabricacaoMaquinas, 
			$anoModeloMaquinas, $tracaoMaquinas, $corMaquinas, $tipoCombustivelMaquinas, $tanqueMaximoMaquinas,
			$codIdInternoMaquinas, $adicionaisMaquinas, $contadorMaquinas, $contadorVariacaoDiaMaquinas, $nfFornecedorMaquinas,
			$nfNumeroMaquinas, $nfDataCompraMaquinas, $nfValorCompraMaquinas, $dataEntregaMaquinas, $nfContadorEntregaMaquinas,
			$numeroImobilizadoMaquinas,	$tempogarantiaMaquinas, $unidadeGarantiaTempoMaquinas, $dataFimGarantiaMaquinas, $garantiaContadorMaquinas,
			$unidadeGarantiaContadorMaquinas, $valorFinalGarantiaMaquinas, $possuiGarantiaExtendidaMaquinas, $tempoGarantia2Maquinas, $unidadeGarantiaTempo2Maquinas,
			$dataFimGarantia2Maquinas, $garantiaContador2Maquinas, $unidadeGarantiaContador2Maquinas, $valorFinalGarantia2Maquinas, $possuiContratoManutencaoMaquinas, 
			$empresaContratoManutencaoMaquinas, $dataInicioContratoManutencaoMaquinas, $dataFimContratoManutencaoMaquinas, $infoContratoManutencaoMaquinas, $dataultimaLeituraMaquinas, 
			$contadorUltimaLeituraMaquinas, $acompanhaTempoMaquinas, $unidadeAcompanhaTempoMaquinas, $acompanhaContadorMaquinas, $unidadeAcompanhaContadorMaquinas);
			
			$dataCadastro = $valueObj->getDataCadastro();
			$idCliente = $valueObj->getIdCliente();
			$nomeMaquina = $valueObj->getNomeMaquina();
			$numeroSerieMaquina = $valueObj->getNumeroSerieMaquina();
			$fabricanteMaquinas = $valueObj->getFabricanteMaquinas();
			$origemMaquinas = $valueObj->getOrigemMaquinas();
			$origemPaisMaquinas = $valueObj->getOrigemPaisMaquinas();
			$modeloMaquinas = $valueObj->getModeloMaquinas();
			$numeroChassiMaquinas = $valueObj->getNumeroChassiMaquinas();
			$anoFabricacaoMaquinas = $valueObj->getAnoFabricacaoMaquinas();
			
			$anoModeloMaquinas = $valueObj->getAnoModeloMaquinas();
			$tracaoMaquinas = $valueObj->getTracaoMaquinas();
			$corMaquinas = $valueObj->getCorMaquinas();
			$tipoCombustivelMaquinas = $valueObj->getTipoCombustivelMaquinas();
			$tanqueMaximoMaquinas = $valueObj->getTanqueMaximoMaquinas();
			$codIdInternoMaquinas = $valueObj->getCodIdInternoMaquinas();
			$adicionaisMaquinas = $valueObj->getAdicionaisMaquinas();
			$contadorMaquinas = $valueObj->getContadorMaquinas();
			$contadorVariacaoDiaMaquinas = $valueObj->getContadorVariacaoDiaMaquinas();
			$nfFornecedorMaquinas = $valueObj->getNfFornecedorMaquinas();
			
			$nfNumeroMaquinas = $valueObj->getNfNumeroMaquinas();
			$nfDataCompraMaquinas = $valueObj->getNfDataCompraMaquinas();
			$nfValorCompraMaquinas = $valueObj->getNfValorCompraMaquinas();
			$dataEntregaMaquinas = $valueObj->getDataEntregaMaquinas();
			$nfContadorEntregaMaquinas = $valueObj->getNfContadorEntregaMaquinas();
			$numeroImobilizadoMaquinas = $valueObj->getNumeroImobilizadoMaquinas();
			$tempogarantiaMaquinas = $valueObj->getTempogarantiaMaquinas();
			$unidadeGarantiaTempoMaquinas = $valueObj->getUnidadeGarantiaTempoMaquinas();
			$dataFimGarantiaMaquinas = $valueObj->getDataFimGarantiaMaquinas();
			$garantiaContadorMaquinas = $valueObj->getGarantiaContadorMaquinas();
			
			$unidadeGarantiaContadorMaquinas = $valueObj->getUnidadeGarantiaContadorMaquinas();
			$valorFinalGarantiaMaquinas = $valueObj->getValorFinalGarantiaMaquinas();
			$possuiGarantiaExtendidaMaquinas = $valueObj->getPossuiGarantiaExtendidaMaquinas();
			$tempoGarantia2Maquinas = $valueObj->getTempoGarantia2Maquinas();
			$unidadeGarantiaTempo2Maquinas = $valueObj->getUnidadeGarantiaTempo2Maquinas();
			$dataFimGarantia2Maquinas = $valueObj->getDataFimGarantia2Maquinas();
			$garantiaContador2Maquinas = $valueObj->getGarantiaContador2Maquinas();
			$unidadeGarantiaContador2Maquinas = $valueObj->getUnidadeGarantiaContador2Maquinas();
			$valorFinalGarantia2Maquinas = $valueObj->getValorFinalGarantia2Maquinas();
			$possuiContratoManutencaoMaquinas = $valueObj->getPossuiContratoManutencaoMaquinas();
			
			$empresaContratoManutencaoMaquinas = $valueObj->getEmpresaContratoManutencaoMaquinas();
			$dataInicioContratoManutencaoMaquinas = $valueObj->getDataInicioContratoManutencaoMaquinas();
			$dataFimContratoManutencaoMaquinas = $valueObj->getDataFimContratoManutencaoMaquinas();
			$infoContratoManutencaoMaquinas = $valueObj->getInfoContratoManutencaoMaquinas();
			$dataultimaLeituraMaquinas = $valueObj->getDataultimaLeituraMaquinas();
			$contadorUltimaLeituraMaquinas = $valueObj->getContadorUltimaLeituraMaquinas();
			$acompanhaTempoMaquinas = $valueObj->getAcompanhaTempoMaquinas();
			$unidadeAcompanhaTempoMaquinas = $valueObj->getUnidadeAcompanhaTempoMaquinas();
			$acompanhaContadorMaquinas = $valueObj->getAcompanhaContadorMaquinas();
			$unidadeAcompanhaContadorMaquinas = $valueObj->getUnidadeAcompanhaContadorMaquinas();
	...
	public function updateMaquinas(Maquinas $maquinas)
	{
		...
		try 
		{
			$sql = mysqli_prepare($conecta,"UPDATE dbmaquinas SET dataCadastro = ?, idCliente = ?, nomeMaquina = ?,
			...
			valorFinalGarantia2Maquinas = ?, possuiContratoManutencaoMaquinas = ?,empresaContratoManutencaoMaquinas = ?, 
			dataInicioContratoManutencaoMaquinas = ?, dataFimContratoManutencaoMaquinas = ?, infoContratoManutencaoMaquinas = ?, 
			...
			unidadeAcompanhaContadorMaquinas = ? WHERE idMaquinas = ?");
			
			mysqli_bind_param($sql,'ssssssssssssssssssssssssssssssssssssssssssssssssssi', 
			$dataCadastro, $idCliente,$nomeMaquina,$numeroSerieMaquina, $fabricanteMaquinas,          
			$origemMaquinas,$origemPaisMaquinas, $modeloMaquinas, $numeroChassiMaquinas, $anoFabricacaoMaquinas, 
			$anoModeloMaquinas, $tracaoMaquinas, $corMaquinas, $tipoCombustivelMaquinas, $tanqueMaximoMaquinas,
			$codIdInternoMaquinas, $adicionaisMaquinas, $contadorMaquinas, $contadorVariacaoDiaMaquinas, $nfFornecedorMaquinas,
			...
			$dataFimGarantia2Maquinas, $garantiaContador2Maquinas, $unidadeGarantiaContador2Maquinas, $valorFinalGarantia2Maquinas, $possuiContratoManutencaoMaquinas, 
			$empresaContratoManutencaoMaquinas, $dataInicioContratoManutencaoMaquinas, $dataFimContratoManutencaoMaquinas, $infoContratoManutencaoMaquinas, $dataultimaLeituraMaquinas, 
			$contadorUltimaLeituraMaquinas, $acompanhaTempoMaquinas, $unidadeAcompanhaTempoMaquinas, $acompanhaContadorMaquinas, $unidadeAcompanhaContadorMaquinas, $idMaquinas);
	...
	public function cadastrarEquipamentos(Equipamentos $equipamentos)
	{
		$conecta = new Connecta();
		$valueObj = (object)$equipamentos;
		$idequipamentos = '';
		$dataCadastro = '';
		$idCliente = '';
		$nome = '';
		...
		try 
		{
			$sql = mysqli_prepare($conecta,"INSERT INTO dbequipamentos  
			VALUES ('', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
			 ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
			
			mysqli_bind_param($sql,'ssssssssssssssssssssssssssssssssssssss', 
			$dataCadastro, $idCliente, $nome, $numeroSerie, $fabricante, $origem, $origemPais, $modelo, $numeroChassi,
			...
			$dataCadastro = $valueObj->getDataCadastro();
			$idCliente = $valueObj->getIdCliente();
			$nome = $valueObj->getNome();
			$numeroSerie = $valueObj->getNumeroSerie();
			$fabricante = $valueObj->getFabricante();
			$origem = $valueObj->getOrigem();
			$origemPais = $valueObj->getOrigemPais();
			$modelo = $valueObj->getModelo();
			$numeroChassi = $valueObj->getNumeroChassi();
			$anoFabricacao = $valueObj->getAnoFabricacao();
			$anoModelo = $valueObj->getAnoModelo();
			$cor = $valueObj->getCor();
			$coldIdInterno = $valueObj->getColdIdInterno();
			$tipoAlimentacao = $valueObj->getTipoAlimentacao();
			$tipoAlimentacaoAC = $valueObj->getTipoAlimentacaoAC();
			$tipoAlimentacaoDC = $valueObj->getTipoAlimentacaoDC();
			$alimentacaoOutros = $valueObj->getAlimentacaoOutros();
			$possuiAcessorios = $valueObj->getPossuiAcessorios();
			$acessorios = $valueObj->getAcessorios();
			$adicionais = $valueObj->getAdicionais();
			$nfFornecedor = $valueObj->getNfFornecedor();
			$nfNumero = $valueObj->getNfNumero();
			$nfDataCompra = $valueObj->getNfDataCompra();
			$nfValorCompra = $valueObj->getNfValorCompra();
			$nfDataEntrega = $valueObj->getNfDataEntrega();
			$numeroImobilizado = $valueObj->getNumeroImobilizado();
			$tempoGarantia = $valueObj->getTempoGarantia();
			$unidadeGarantiaTempo = $valueObj->getUnidadeGarantiaTempo();
			$dataFimGarantia = $valueObj->getDataFimGarantia();
			$possuiGarantiaExtendida = $valueObj->getPossuiGarantiaExtendida();
			$tempoGarantia2 = $valueObj->getTempoGarantia2();
			$unidadeGarantiaTempo2 = $valueObj->getUnidadeGarantiaTempo2();
			$datafimGarantia2 = $valueObj->getDatafimGarantia2();
			$possuiContratoManutencao = $valueObj->getPossuiContratoManutencao();
			$empresaContratoManutencao = $valueObj->getEmpresaContratoManutencao();
			$dataInicioContratoManutencao = $valueObj->getDataInicioContratoManutencao();
			$dataFimContratoManutencao = $valueObj->getDataFimContratoManutencao();
			$infoContratoManutencao = $valueObj->getInfoContratoManutencao();
	...
	public function updateequipamentos(Equipamentos $equipamentos)
	{
		$conecta = new Connecta();
		$valueObj = (object)$equipamentos;
		$idequipamentos = '';
		...
		try 
		{
			$sql = mysqli_prepare($conecta,"UPDATE dbequipamentos  
			SET ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
			 ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
