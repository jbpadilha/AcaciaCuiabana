...
<?php 
if(isset($_GET['fichaAtendimento']))
{
?>
<legend class="subtitulo" align="center">Gerar Ficha de Atendimento Nº <?=$_GET['fichaAtendimento']?>:</legend>
<br/>
<form name="fichaAte" id="fichaAte" method="get" action="../application/recebePostGet.php" target="_blank">
	<input type="hidden" id="control" name="control" value="GerarPDF"/>
	<input type="hidden" id="funcao" name="funcao" value="FichaAtendimento"/>
	<input type="hidden" id="identrevista" name="identrevista" value="<?=$_GET['identrevista']?>"/>
	<input type="submit" name="submit" id="submit" value="Gerar Ficha Atendimento em PDF"/>
</form>
<br/><br/><br/>
<?
}
