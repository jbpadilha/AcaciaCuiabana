...
$langvars = array (
	'CHARSET' => 'UTF-8',
	'PHPSHOP_USER_LIST_LBL' => '會員列表',
	'PHPSHOP_USER_LIST_USERNAME' => '會員名稱',
	'PHPSHOP_USER_LIST_FULL_NAME' => '姓名',
	'PHPSHOP_USER_LIST_GROUP' => '群組',
	'PHPSHOP_USER_FORM_LBL' => '增加/更新 會員資訊',
	'PHPSHOP_USER_FORM_PERMS' => '野i權',
	'PHPSHOP_USER_FORM_CUSTOMER_NUMBER' => 'Customer Number / ID',
	'PHPSHOP_MODULE_LIST_LBL' => '模組清單',
	'PHPSHOP_MODULE_LIST_NAME' => '模組名',
	'PHPSHOP_MODULE_LIST_PERMS' => '模組參數',
	'PHPSHOP_MODULE_LIST_FUNCTIONS' => '函數',
	'PHPSHOP_MODULE_FORM_LBL' => '模組資訊',
	'PHPSHOP_MODULE_FORM_MODULE_LABEL' => '模組標題(用於上方選單)',
	'PHPSHOP_MODULE_FORM_NAME' => '模組名',
	'PHPSHOP_MODULE_FORM_PERMS' => '模組參數',
	'PHPSHOP_MODULE_FORM_HEADER' => '模組 header',
	'PHPSHOP_MODULE_FORM_FOOTER' => '模組 footer',
	'PHPSHOP_MODULE_FORM_MENU' => '在管理弁鄋矰勿膆僂珩?',
	'PHPSHOP_MODULE_FORM_ORDER' => '顯示順序',
	'PHPSHOP_MODULE_FORM_DESCRIPTION' => '模組描述',
	'PHPSHOP_MODULE_FORM_LANGUAGE_CODE' => '語言編碼',
	'PHPSHOP_MODULE_FORM_LANGUAGE_FILE' => 'Language File',
	'PHPSHOP_FUNCTION_LIST_LBL' => '函數列表',
	'PHPSHOP_FUNCTION_LIST_NAME' => '函數名稱',
	'PHPSHOP_FUNCTION_LIST_CLASS' => 'class 名稱',
	'PHPSHOP_FUNCTION_LIST_METHOD' => 'class 方法',
	'PHPSHOP_FUNCTION_LIST_PERMS' => '參數',
	'PHPSHOP_FUNCTION_FORM_LBL' => '函數資訊',
	'PHPSHOP_FUNCTION_FORM_NAME' => '函數名稱',
	'PHPSHOP_FUNCTION_FORM_CLASS' => 'class名稱',
	'PHPSHOP_FUNCTION_FORM_METHOD' => 'class方法',
	'PHPSHOP_FUNCTION_FORM_PERMS' => '函數參數',
	'PHPSHOP_FUNCTION_FORM_DESCRIPTION' => '函數描述',
	'PHPSHOP_CURRENCY_LIST_LBL' => '貨幣列表',
	'PHPSHOP_CURRENCY_LIST_NAME' => '貨幣名稱',
	'PHPSHOP_CURRENCY_LIST_CODE' => '貨幣代碼',
	'PHPSHOP_COUNTRY_LIST_LBL' => '國家列表',
	'PHPSHOP_COUNTRY_LIST_NAME' => '國名',
	'PHPSHOP_COUNTRY_LIST_3_CODE' => '國家代碼(3)',
	'PHPSHOP_COUNTRY_LIST_2_CODE' => '國家代碼(2)',
	'PHPSHOP_STATE_LIST_MNU' => '列出州名',
	'PHPSHOP_STATE_LIST_LBL' => '州名清單給: ',
	'PHPSHOP_STATE_LIST_ADD' => '增加/更新一個州',
	'PHPSHOP_STATE_LIST_NAME' => '州名',
	'PHPSHOP_STATE_LIST_3_CODE' => '州碼 (3)',
	'PHPSHOP_STATE_LIST_2_CODE' => '州碼 (2)',
	'PHPSHOP_ADMIN_CFG_GLOBAL' => '全域設定',
	'PHPSHOP_ADMIN_CFG_SITE' => '網站',
	'PHPSHOP_ADMIN_CFG_SHIPPING' => '送貨',
	'PHPSHOP_ADMIN_CFG_CHECKOUT' => '結帳',
	'PHPSHOP_ADMIN_CFG_DOWNLOADABLEGOODS' => '下載',
	'PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE' => '僅用於目錄',
	'PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE_EXPLAIN' => '如果選擇本項, 您將終止所有購物車弁遄C',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES' => '顯示價格',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES_EXPLAIN' => '選擇以顯示價格。 如果使用了目錄弁? 有些情況下可能不需要在頁面上顯示價格。',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX' => '實際稅款',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX_EXPLAIN' => '這將決定零重量物品是否含稅。 修改 ps_checkout.php->calc_order_taxable()以自定義。',
	'PHPSHOP_ADMIN_CFG_TAX_MODE' => '稅金模式:',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_SHIP' => '以送貨地址',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_VENDOR' => '以零售商地址',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_EXPLAIN' => '這將決定了計算稅金的時候採用何種稅率:<br /> 
                                                <ul><li>這取決於商店擁有者來自哪個地區/國家</li><br />
                                                <li>或是客戶的地區/國家.</li></ul>',
	'PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE' => '啟用多重稅率?',
	'PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE_EXPLAIN' => '如果您所銷售的商品稅率不同的話，選擇此項。 (比如說圖書是7%的稅率，而其他商品是16%的稅率)',
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE' => '計算稅金/運費之前減去折扣?',
	'PHPSHOP_ADMIN_CFG_REVIEW' => '啟用顧客評價系統',
	'PHPSHOP_ADMIN_CFG_REVIEW_EXPLAIN' => '如果啟用的話, 您將允傅U客 <strong>評價產品</strong> 以及 <strong>撰寫評論</strong> 。 <br />
                                                                                這樣顧客可以寫下他們的體驗，為別的顧客提供參考。 <br />',
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE_EXPLAIN' => '設定這個標記來決定計算稅金/運費之前減去折扣還是之後再減去折扣。',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS' => '必須同意服務條款?',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_EXPLAIN' => '如果你想讓你的顧客註冊的時候同意服務條款，選擇此項。',
	'PHPSHOP_ADMIN_CFG_CHECK_STOCK' => '檢查存貨?',
	'PHPSHOP_ADMIN_CFG_CHECK_STOCK_EXPLAIN' => '此設置在用戶將物品加到購物車的時候，是否檢查存貨狀況。
                                                                                          如果設定，商店將不允傅U客加入超出存貨數量的商品。',
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE' => '啟用加盟程式?',
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE_EXPLAIN' => '如果您在商店後台設置加盟商的話，這將會在商店前端啟用代理商追蹤。',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT' => '訂單郵件格式:',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_TEXT' => '純文字郵件',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_HTML' => 'HTML郵件',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_EXPLAIN' => '這決定了您的訂單確認郵件將以何種方式寄出:<br />
                                                                                        <ul><li>簡單的純文字郵件</li>
                                                                                        <li>或者是帶有圖片的HTML郵件。</li></ul>',
	'PHPSHOP_ADMIN_CFG_FRONTENDAMDIN' => '允釩D後臺管理員使用前端管理程式?',
	'PHPSHOP_ADMIN_CFG_FRONTENDAMDIN_EXPLAIN' => '這個設置項可以為那些無法訪問後臺管理程式(比如 註冊會員/作者等級)
                                                   的商店管理員啟用前臺管理。',
	'PHPSHOP_ADMIN_CFG_URLSECURE' => '加密保護URL',
	'PHPSHOP_ADMIN_CFG_URLSECURE_EXPLAIN' => '加密保護安全位址. (https 開頭， 以斜線結尾)',
	'PHPSHOP_ADMIN_CFG_HOMEPAGE' => '首頁',
	'PHPSHOP_ADMIN_CFG_HOMEPAGE_EXPLAIN' => '預設載入的網頁',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE' => '錯誤頁面',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE_EXPLAIN' => '預設出現錯誤時的頁面',
	'PHPSHOP_ADMIN_CFG_DEBUG' => '除錯 ?',
	'PHPSHOP_ADMIN_CFG_DEBUG_EXPLAIN' => '除錯?  	   	打開除錯的輸出. 這將會把除錯頁面顯示在每個正常頁面的底部。此資訊在商店建立階段非常有用。',
	'PHPSHOP_ADMIN_CFG_FLYPAGE' => '商品頁面',
	'PHPSHOP_ADMIN_CFG_FLYPAGE_EXPLAIN' => '這是顯示商品詳情的預設頁面.',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE' => '類別範本',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN' => '這定義了在目錄中顯示商品的預設範本。<br />
                                                        您可以修改現有範本以新增新範本。<br />
                                                        (位於<strong>COMPONENTPATH/html/templates/</strong> 目錄下面，名稱以“browse_”起始)',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW' => '每行中商品預設數目',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN' => '這裏定義了每行中顯示商品的數目 <br />
                                                                                                      例如，如果你設置為4,那麼目錄範本中就會在每列顯示四個商品。',
	'PHPSHOP_ADMIN_CFG_NOIMAGEPAGE' => '“無圖片” 的圖片',
	'PHPSHOP_ADMIN_CFG_NOIMAGEPAGE_EXPLAIN' => '在商品無圖片可用時，顯示此圖片。',
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION' => '顯示 footer ',
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN' => '顯示一個powered-by-mambo-phpShop的 footer 圖片。',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD' => '分別配置的運送者跟運費的標準送貨模組。<strong>推薦 !</strong>',
	...
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_DISABLE' => '停用選擇運送方式. 如果您的顧客購買可下載貨品時並不需要運送, 請選擇.',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR' => '啟用結帳櫃檯',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR_EXPLAIN' => '如果你想在顧客結賬過程中顯示結帳櫃檯(顯示1-2-3-4的圖片進度條)，選擇此項。',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS' => '選擇您商店的結帳步驟',
	'PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS' => '啟用下載',
	'PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS_EXPLAIN' => '選擇此項會啟用下載弁遄C適用於銷售可下載商品的情況。',
	'PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS' => '訂購狀態啟動下載',
	'PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS_EXPLAIN' => '選擇顧客下載通知 email 的訂購狀態.',
	'PHPSHOP_ADMIN_CFG_ORDER_DISABLE_DOWNLOADS' => '終止下載的訂購狀態',
	'PHPSHOP_ADMIN_CFG_ORDER_DISABLE_DOWNLOADS_EXPLAIN' => '選擇顧客下載終止通知 email 的訂購狀態.',
	'PHPSHOP_ADMIN_CFG_DOWNLOADROOT' => '下載根目錄',
	'PHPSHOP_ADMIN_CFG_DOWNLOADROOT_EXPLAIN' => '給顧客下載檔案的實體路徑. (請以斜線結尾!)<br>
        <span class="message">為了您的商店的安全: 如果可以, 請使用網站根目錄之外的目錄</span>',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_MAX' => '下載最多',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_MAX_EXPLAIN' => '設定一個下載-ID可以用來下載的次數, (給一次訂購)',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE' => '下載期滿',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE_EXPLAIN' => '設定可以讓顧客下載的時間範圍並 <strong>以秒計算</strong>. 
     從第一次下載開始計算時間! 當時間期滿, 此download-ID 將停用.<br />注意 : 86400秒=24小時.',
	'PHPSHOP_COUPONS' => '優待',
	'PHPSHOP_COUPONS_ENABLE' => '啟動優待使用',
	'PHPSHOP_COUPONS_ENABLE_EXPLAIN' => '假使您啟動, 表示允傅U客使用優待兌換代碼來換取折扣.',
	'PHPSHOP_ADMIN_CFG_PDF_BUTTON' => 'PDF-按鈕',
	'PHPSHOP_ADMIN_CFG_PDF_BUTTON_EXPLAIN' => '商店內顯示或是隱藏 PDF-按鈕',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER' => '每次訂購都必須同意使用條款?',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER_EXPLAIN' => '選取假如您要顧客每次訂購都要同意您的使用條款 (下單之前).',
	'PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS' => '顯示沒有庫存的商品',
	'PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS_EXPLAIN' => '當啟用時, 將會陳列出沒有庫存的商品. 不然這類商品會是隱藏的.',
