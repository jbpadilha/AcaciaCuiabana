...
function saveconfig() {
	...
	$sendmailtoadmin=mosGetParam( $_POST, 'sendmailtoadmin', null );
	$sendmailtoauthor=mosGetParam( $_POST, 'sendmailtoauthor', null );
	$writeresultstofile=mosGetParam( $_POST, 'writeresultstofile', null );	
	...
	$configtxt .= "\$sendmailtoadmin = \"$sendmailtoadmin\";\n";
	$configtxt .= "\$sendmailtoauthor = \"$sendmailtoauthor\";\n";
	$configtxt .= "\$writeresultstofile = \"$writeresultstofile\";\n";
...
global $database;
$database->setQuery("UPDATE #__seyret_check SET joomlaalemuserid='$id', securitycode1='', securitycode2=''");
	if (!$database->query()){
		echo "<script> alert('".$row->getError()."'); window.history.go(-1); </script>n";
		exit();
	}
