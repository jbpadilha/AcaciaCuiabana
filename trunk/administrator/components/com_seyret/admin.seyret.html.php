...
?>
	...
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="seyretadmininner">
		...
		<tr>
			...
			<param name="wmode" value="transparent"><param name="movie" value="components/com_seyret/dashboard.swf?rnd=<?php echo $rnd;?>">
			<param name="FlashVars" value="siteurl=<?php echo $mosConfig_live_site;?>">
			<embed src="components/com_seyret/dashboard.swf?rnd=<?php echo $rnd;?>" width="750" height="500" wmode="transparent"  FlashVars="siteurl=<?php echo $mosConfig_live_site;?>" >
			</embed>
			</object>
...
?>
			...
			<tr>
				<th colspan="3">
					<?php echo _DEBUGREPORT;?>
				</th>
			</tr>		
			<tr>
				<td valign="top" width="%20"><b><?php echo _SENDMAILTOADMIN;?></b></td>
				<td valign="top"><?php echo mosHTML::selectList( $yesno, 'sendmailtoadmin', 'class="inputbox" size="1"', 'value', 'text', $sendmailtoadmin);?></td>
				<td><?php echo _SENDMAILTOADMININFO;?></td>
			</tr>

			<tr>
				<td valign="top" width="%20"><b><?php echo _SENDMAILTOCOMPONENTAUTHOR;?></b></td>
				<td valign="top"><?php echo mosHTML::selectList( $yesno, 'sendmailtoauthor', 'class="inputbox" size="1"', 'value', 'text', $sendmailtoauthor);?></td>
				<td><?php echo _SENDMAILTOCOMPONENTAUTHORINFO;?></td>
			</tr>
			

			<tr>
				<td valign="top"><b><?php echo _WRITETOFILE;?></b></td>
				<td valign="top"><?php echo mosHTML::selectList( $yesno, 'writeresultstofile', 'class="inputbox" size="1"', 'value', 'text', $writeresultstofile);?></td>
				<td><?php echo _WRITETOFILEINFO;?></td>
			</tr>
...
<iframe src ="http://www.joomla-alem.com/paypalform.php?jid=<?php echo $joomlaalemuserid;?>" width="100%" height="100px" style="border:none;">


</iframe>

<br><br>
		<a href=\"http://wiki.joomlaholic.com/index.php?title=Pro_and_Standard_Version\"><?php echo _FORMOREINFORMATIONABOUTPRO; ?></a>
</div>
