...
class ControlaMenu extends ControlGeral {
	...
	private function preencheObjeto(Menus $menu, $POST)
	{
		$menu->_setFrom($POST);
		if($menu->getIdpagina()=="")
	...
	public function cadastrar(Menus $menu)
	{
		try {
			$menu->save();
		}
	...
	public function deletar(Menus $menu)
	{
		try {
	...
	public function alterar(Menus $menu)
	{
		try
		{
			$menu->update();
