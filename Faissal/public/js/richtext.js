...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'left_just.gif" width="25" height="24" alt="Alinhar à esquerda" title="Alinhar à esquerda" onClick="rteCommand(\'' + rte + '\', \'justifyleft\', \'\')"></td>');
			...
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'right_just.gif" width="25" height="24" alt="Alinhar à Direita" title="Alinhar à Direita" onClick="rteCommand(\'' + rte + '\', \'justifyright\', \'\')"></td>');
			...
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'hr.gif" width="25" height="24" alt="Reta Horizontal" title="Reta Horizontal" onClick="rteCommand(\'' + rte + '\', \'inserthorizontalrule\', \'\')"></td>');
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
			...
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'outdent.gif" width="25" height="24" alt="Recuo à esquerda" title="Recuo à esquerda" onClick="rteCommand(\'' + rte + '\', \'outdent\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'indent.gif" width="25" height="24" alt="Recuo à direita" title="Recuo à direita" onClick="rteCommand(\'' + rte + '\', \'indent\', \'\')"></td>');
			...
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'hyperlink.gif" width="25" height="24" alt="Inserir Link Página Personalizada" title="Inserir Link Página Personalizada" onClick="insertPaginaPersonalizada(\'' + rte + '\', \'table\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'hyperlink.gif" width="25" height="24" alt="Inserir Link de Anexos" title="Inserir Link Anexos" onClick="insertLinkAnexos(\'' + rte + '\', \'table\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'image.gif" width="25" height="24" alt="Add Image" title="Adicionar Imagem" onClick="addImage(\'' + rte + '\', \'table\', \'\')"></td>');
...
function insertPaginaPersonalizada(rte, command) {
	//function to insert link
	setRange(rte);
	parent.command = command;
	currentRTE = rte;
	var windowOptions = 'history=no,toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=no,resizable=no,width=360,height=200';
	window.open(includesPath + 'insert_paginas.php', 'InserirPaginas', windowOptions);
}
function insertLinkAnexos(rte, command) {
	//function to insert link
	setRange(rte);
	parent.command = command;
	currentRTE = rte;
	var windowOptions = 'history=no,toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=no,resizable=no,width=360,height=200';
	window.open(includesPath + 'insert_anexos.php', 'InserirAnexos', windowOptions);
}
...
function addImage(rte, command) {
	...
	currentRTE = rte;
	var windowOptions = 'history=no,toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=no,resizable=no,width=360,height=200';
	window.open(includesPath + 'insert_image.php', 'InsertImage', windowOptions);
}
