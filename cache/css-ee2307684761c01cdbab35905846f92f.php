...
div#quickfaq{overflow:hidden}div#quickfaq
.clear{border:0px
none;clear:both;float:none;font-size:1px;height:0;line-height:1px;margin:0;padding:0;visibility:hidden}div#quickfaq .floattext:after{content:".";display:block;height:0;clear:both;visibility:hidden}div#quickfaq
.floattext{display:block}div#quickfaq
.buttons{float:right}div#quickfaq .buttons
img{border:none}div#quickfaq .buttons
a{padding:0
0 0 5px;height:16px;line-height:16px}div#quickfaq
h2{}div#quickfaq h2
img{border:none}div#quickfaq .pageslinks,
div#quickfaq
.pagescounter{text-align:center}div#quickfaq
.catimg{margin:0
0.5em 0.5em 0;float:left;position:relative}div#quickfaq .catimg
p{font-size:0.9em;line-height:180%;margin:0
0 0.5em 0}div#quickfaq
.catdescription{margin:0
0 0.5em 0}div#quickfaq
.subcategories{border-bottom:2px solid #ddd;padding:0.5em 0.3em;margin:0.8em 0}div#quickfaq
.taglist{margin:5px
0 10px;padding:0
5px}div#quickfaq
.item_details{border:1px
dashed silver;padding:0.8em;margin-bottom:10px}div#quickfaq .item_details
dl{margin:0;float:left;width:48%}div#quickfaq
dl.item_info_right{float:right}div#quickfaq
dt{margin:0;padding:0.3em 0;float:left;font-size:1em;font-weight:bold;width:11em;background:transparent;border-bottom:1px solid #ddd}div#quickfaq
dd{display:block;margin:0
0 5px 12em;padding:0.3em 0;font-size:1em;background:transparent}div#quickfaq
div.description{margin:5px
0;padding:0
5px}* html .floattext
dd{height:1%}div#quickfaq
table.faqitemtable{margin:1em
1px;width:99%;font-size:1em;border-collapse:collapse;border:1px
solid #E5E5E5}div#quickfaq table.faqitemtable
th{background-color:#EFEFEF;color:#000;font-weight:bold;padding:0.4em;text-align:left;border-bottom:1px solid #e5e5e5;border-right:1px solid #E5E5E5}div#quickfaq table.faqitemtable th
img{margin:0
0 5px 5px;vertical-align:middle;border:none}div#quickfaq table.faqitemtable
td{padding:0.4em;border-bottom:1px solid #e5e5e5;border-right:1px solid #E5E5E5;vertical-align:top}div#quickfaq table.faqitemtable tr.sectiontableentry2
td{background:#F4F4F4}div#quickfaq table.faqitemtable tr:hover
td{background:#F8F8F8}div#quickfaq table.faqitemtable th td
#qf_title{text-align:left;width:80%}div#quickfaq table.faqitemtable th td
#qf_votes{text-align:center;width:10%}div#quickfaq table.faqitemtable th td
#qf_hits{text-align:center;width:10%}div#quickfaq
#qf_filter{margin:1em
0 0.5em 0;padding:0.5em;border:solid 1px #ddd}div#quickfaq
.qf_fleft{float:left}div#quickfaq
.qf_fright{float:right}div.qf_edit form
fieldset{margin:0
0 1em 0;padding:1em;border:1px
solid #ddd}div.qf_edit form
legend{padding:0.3em;font-weight:bold}div.qf_edit form
label{width:9em;margin:0;padding:0;float:left;display:block;vertical-align:top}div.qf_edit form input,
div.qf_edit form button,
div.qf_edit form select,
div.qf_edit form
textarea{margin:0
0 0.5em 0;padding:0.2em;border:1px
solid #ddd;cursor:pointer;background-color:#fff}div.qf_save_buttons{margin:0
0 1em 0;float:right}div.qf_save_buttons
button{font-size:1.5em;cursor:pointer}div.qf_box_left,div.qf_box_right{width:45%;float:left}div.qf_box_right{float:right}div#quickfaq
.qf_ratingbarcontainer{border:1px
solid #999;height:10px;width:60px;margin:2px
2px;display:block}div#quickfaq
.qf_ratingbar{background-color:silver;height:10px;display:block}div#quickfaq
.qf_tagline{width:auto;height:30px;margin-left:auto;margin-right:auto;display:block}div#quickfaq
.qf_tag{width:150px;display:block;float:left;margin:2px
2px}div#quickfaq
.qf_tagidbox{width:20px;display:block;float:left}div#quickfaq
.qf_centerimg{text-align:center;margin-top:0px;margin-bottom:0px;padding:0px}div#quickfaq
.qf_addtag{margin-top:10px}.qf_statetoggler{padding:0;list-style:none;width:10px}.options{position:absolute}#statetoggler li ul
li{border:#ddd 1px solid;background-color:#fff;color:#000;padding:2px;list-style:none}.app-box{width:100%;margin-bottom:15px;display:inline-block}.app-box-header{background:url('/ligante3/components/com_quickfaq/assets/images/box-header.png') no-repeat scroll 0 0;background-position:left top;height:46px;padding-left:10px;margin-right:14px;position:relative}.app-box-header .app-box-header{background-position:right top;background:url('/ligante3/components/com_quickfaq/assets/images/box-header-right.png') no-repeat scroll right 0;padding:0px
10px 0px 0px;margin-right:-14px}.app-box-header.no-background,
.app-box-header.no-background .app-box-header{background:none;padding:0}.app-box-title, h2.app-box-title
a{color:#789539;font-weight:bold;line-height:30px;background:none;margin:0;padding-top:6px}.app-box-menus{position:absolute;top:0;right:0;margin:8px}.app-box-menu{float:right;cursor:pointer;margin-left:5px}.app-box-menu-title{display:block;text-indent: -9999px}.app-box-menu-icon{background-image:url('/ligante3/components/com_quickfaq/assets/images/app-box-menu-icon.png');background-repeat:no-repeat;margin-top:10px;height:16px;width:16px;line-height:0;display:block}.app-box-menu-icon:focus{outline:none}.app-box-menu.options .app-box-menu-icon{background-position:0 0}.app-box-menu.toggle .app-box-menu-icon{background-position: -16px 0}.app-box.collapse .app-box-menu.toggle .app-box-menu-icon{background-position: -32px 0}.app-box-content{background:url('/ligante3/components/com_quickfaq/assets/images/app-box-filerlink.png') no-repeat;border:1px
...
DIV.ButtonLeft{float:left;background-image:url('/ligante3/components/com_quickfaq/assets/images/home-btn-on-lft.gif');height:26px;width:8px;background-repeat:no-repeat;margin-left:5px;cursor:pointer;background-position-y:50%}div.buttonlink a.active-state .Button DIV.ButtonRight,  div.bottonGroup a.active-state .Button
DIV.ButtonRight{float:left;background-image:url('/ligante3/components/com_quickfaq/assets/images/home-btn-on-rgt.gif');height:26px;width:8px;background-repeat:no-repeat;cursor:pointer;background-position-y:50%}div.buttonlink a.active-state .Button DIV.ButtonMiddle,  div.bottonGroup a.active-state .Button
DIV.ButtonMiddle{color:#fff;font-family:Verdana;font-size:11px;float:left;background-image:url('/ligante3/components/com_quickfaq/assets/images/home-btn-on-bg.gif');height:25px;background-repeat:repeat-x;text-align:center;cursor:pointer;padding-top:1px}div.buttonlink a.active-state .Button p.TextBg,  div.bottonGroup a.active-state .Button
p.TextBg{float:left;color:#FFF;text-align:center;font-family:Verdana;font-size:11px;background-image:url('/ligante3/components/com_quickfaq/assets/images/home-btn-on-arrow.gif');background-repeat:no-repeat;background-position:center bottom;height:26px}div.buttonlink a.active-state .Button p.Text,  div.bottonGroup a.active-state .Button
...
DIV.ButtonLeft{float:left;background-image:url('/ligante3/components/com_quickfaq/assets/images/home-btn-off-lft.gif');height:26px;width:8px;background-repeat:no-repeat;margin-left:5px;cursor:pointer;background-position-y:50%}div.buttonlink a .Button DIV.ButtonMiddle,  div.bottonGroup a .Button
DIV.ButtonMiddle{float:left;background-image:url('/ligante3/components/com_quickfaq/assets/images/home-btn-off-bg.gif');height:25px;background-repeat:repeat-x;text-align:center;cursor:pointer;background-position-y:50%;padding-top:1px}div.buttonlink a .Button DIV.ButtonRight,  div.bottonGroup a .Button
DIV.ButtonRight{float:left;background-image:url('/ligante3/components/com_quickfaq/assets/images/home-btn-off-rgt.gif');height:26px;width:8px;background-repeat:no-repeat;cursor:pointer;background-position-y:50%}div.buttonlink a .Button p.TextBg,  div.bottonGroup a .Button
