...
class QDAO 
{
	...
	public function findMaquinas(Maquinas $maquinas)
	{
		...
		{
			throw new Exception("Não foi posssãvel listar a tabela dbMaquinas. ".$e->getMessage());
		}
		$conecta = null;
		$valueObj = null;
		return $collVo;
	...
	/**
	 * Método de Procura / Listagem de Equipamentos
	...
	public function findEquipamentos(Equipamentos $equipamentos)
	{
		...
		{
			throw new Exception("Não foi posssãvel listar a tabela dbEquipamentos. ".$e->getMessage());
		}
		$conecta = null;
		$valueObj = null;
		return $collVo;
