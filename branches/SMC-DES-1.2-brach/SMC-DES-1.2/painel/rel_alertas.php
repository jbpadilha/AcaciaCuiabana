...
<style>
	...
	div.titulo label { font:bold 22px "Segoe UI", Verdana, Arial; width:280px; color:#FFF; }
...
<div id="cal">
	<div class="titulo">
		<img src="/_global/_img/smc/btLeft.png" alt="Anterior" title="mês anterior" onclick="Request('<?php echo 'rel_alertas.php?require=sim&mes='.($month-1).'&ano='.($year); ?>', 'cal')" />
		<label> <?php echo $month_name .' de '. $year; ?> </label>
		<img src="/_global/_img/smc/btRight.png" alt="Próximo" title="próximo mês" onclick="Request('<?php echo 'rel_alertas.php?require=sim&mes='.($month+1).'&ano='.($year); ?>', 'cal')" />
	</div>
