...
<form name="busca_veiculo" method="POST" action="../class/RecebePostGet.php" >
    ...
    <fieldset>
        <label>Cnh:
            <input name="busca" type="text" class="docCNH" />
        </label>
    </fieldset>
    ...
    <table>
        ...
        <td>Cnh</td>
            ...
            foreach ($collCondutoresPesquisados as $condutor) {
                ...
                ?>
        <tr>
            <td><?php echo $pessoaPesquisada->getNomePessoa(); ?></td>
            <td><?php echo $cnhPesquisado->getNumeroCnh(); ?></td>
            <td>
                <form method="get" action="index.php" >
                    <input type="hidden" name="idCondutorAlterar" value="<?php echo $condutorPesquisado->getIdCondutores(); ?>" />
