...
class ControlaFuncionalidades 
{
	...
	public function validaVeiculoIgual($placa)
	{
		...
		if(!is_null($collVo))
		{
			throw new Exception("Vesãculo já cadastrado.");
		}
		return $placa;
	}
	...
	/**
	 * Método de Procura/Listagem de Avisos de Vesãculos
	...
	/**
	 * Método de Procura/Listagem de Maquinas
	 * @param $maquinas
	 */
	public function findMaquinas(Maquinas $maquinas)
	{
		...
		try
		{
			$this->collVo = $qdao->findMaquinas($maquinas);
		}
		catch (Exception $e)
		{
			throw new Exception($e->getMessage());
	...
	/**
	 * Método que lista os seguros vencidos dos Vesãculos
	 * @param Logon $logon
	 * @param DateTime $data
	 */
	...
	/**
	 * Método de atualização de RevisÃµes
	 * @param Tiporevisoes $tipoRevisoes
	 */
	...
	/**
	 * Método de atualização de Aviso de Vesãculos
	 * @param Avisos $avisosVeiculos
	 */
	...
	/**
	 * Método de Cadastramento de Tipo de RevisÃµes
	 * @param Tiporevisoes $tipoRevisoes
	 */
	...
	/**
	 * Método de Cadastramento de Avisos de Vesãculos
	...
	/**
	 * Método de cadastramento de Maquinas
	 * @param $maquinas
	 */
	public function cadastrarMaquinas(Maquinas $maquinas)
	{
		...
		try 
		{
			$dao->cadastrarMaquinas($maquinas);
		}
		catch (Exception $e)
		{
			throw new Exception($e->getMessage());
	...
	public function cadastrarEquipamentos(Equipamentos $equipamentos)
	{
		...
		try 
		{
			$dao->cadastrarEquipamentos($equipamentos);
		}
		catch (Exception $e)
		{
			throw new Exception($e->getMessage());
