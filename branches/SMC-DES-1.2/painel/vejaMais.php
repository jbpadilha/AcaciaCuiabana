...
if(isset($_GET['listaIpva']))
	$listaIpva = $controla->listaIpvaVencidos($userLogon,$data);

if(isset($_GET['listaSeguro']))
	$listaSeguro = $controla->listaSeguroVencidos($userLogon,$data);	

if(isset($_GET['listaGarantia']))
	$listaGarantia = $controla->ListaGarantiasVenc($userLogon,$data);	

if(isset($_GET['listaRevisoes']))
	$listaRevisoes = $controla->listaRevisoes($userLogon,$data);	
