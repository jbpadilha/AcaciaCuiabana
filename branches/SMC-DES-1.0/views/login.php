<fieldset class="padrao">
	...
	<div id="opcao1" onclick="show('opcao1','opcao2','formlogin','formcadastro','login')">
		<label><img src="imagens/right.png" alt="" /> Sou cadastrado </label>
	</div>

	<div id="opcao2" onclick="show('opcao2','opcao1','formcadastro','formlogin','lnome')">
	...
	<form id="formlogin" name="f_login" method="POST" action="../class/RecebePostGet.php" target="_self" onsubmit="return checkforml(this)">
		...
		<p> <label for="senha">Senha:</label>
			<input class="x3" type="password" tabindex="2" name="senha" id="senha" onfocus="foco('senha', 'x3 foco_on'); SetHelp('pasinfo','Informe uma senha')" onblur="foco('senha', 'x3 foco_off'); SetHelp('pasinfo','')">
			<input type="submit" tabindex="4" value="Entrar">
			<input type="hidden" value="1" id="loginAdm" name="loginAdm">
	...
	<form id="formcadastro" name="loga" action="../class/RecebePostGet.php" method="post" onsubmit="return checkform(this)"> 
		...
		<p> <label for="lemail">E-mail: </label> <input class="x8" type="text" name="lemail" id="lemail" onfocus="foco('lemail', 'x8 foco_on'); SetHelp('hint','Informe um e-mail válido'); " onblur="foco('lemail', 'x8 foco_off'); ValidaEmail('lemail','hint','x8');" >
			<label id="hint" class="info"> </label> </p>
		<p> <label for="llogin">CPF: </label> <input class="x3" type="text" name="llogin"	id="llogin" maxlength="14" onfocus="foco('llogin', 'x3 foco_on'); SetHelp('hlpcpf','Este será o seu login')" onblur="VerificaCPF('llogin','x3','hlpcpf');" >
			<label for="llogin" id="hlpcpf" class="info"> </label> 
		<p> <label for="lsenha">Senha: </label> <input class="x3" type="password" name="lsenha" id="lsenha" maxlength="14" onfocus="foco('lsenha', 'x3 foco_on');" onblur="foco('lsenha', 'x3 foco_off'); SetHelp('hlppass',''); " onKeyUp="ValidaSenha('lsenha','hlppass'); " >
			<input type="submit" value="Cadastrar" name="cadastra">
			<input type="hidden" value="cadastroLogin" id="acao" name="acao">
			<label for="lsenha" id="hlppass" class="info"> </label> </p> 
	</form>
...
<script>
	...
	jQuery(function($){
		...
		$("#login").mask("999.999.999-99",{placeholder:" "});
		$("#llogin").mask("999.999.999-99",{placeholder:" "});
	});
