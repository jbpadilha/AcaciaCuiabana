...
<fieldset> <p class="caption" onclick="blocking('geral');" > InformaçÃµes gerais do Vesãculo <span class="borda"> </span> </p>
	<div id="geral">
		<div id="left" >
			...
			<p> <label> Combustsãvel: </label> <input type="text" name="combustivel" value="<?=$veiculos->getCombustivelVeiculos()?>" class="x4 upper" /> </p>
