<?php
/*
	JoomlaXTC jmodule6  plugin for JomSocial
...
if(!class_exists('plgCommunityjxtcjmodule6')) {
	class plgCommunityjxtcjmodule6 extends CApplications {
		var $name 		= "jmodule6";
		var $_name		= 'jmodule6';
		var $_path		= '';
		var $_user		= '';
		...
		function onProfileDisplay() {
			...
			$callback = array('plgCommunityjxtcjmodule6', '_buildHTML');
		...
		function _buildHTML($that) {
			$position = $that->params->get('position', 'jmodule6');
