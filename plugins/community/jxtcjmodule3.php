<?php
/*
	JoomlaXTC jmodule3  plugin for JomSocial
...
if(!class_exists('plgCommunityjxtcjmodule3')) {
	class plgCommunityjxtcjmodule3 extends CApplications {
		var $name 		= "jmodule3";
		var $_name		= 'jmodule3';
		var $_path		= '';
		var $_user		= '';
		...
		function onProfileDisplay() {
			...
			$callback = array('plgCommunityjxtcjmodule3', '_buildHTML');
		...
		function _buildHTML($that) {
			$position = $that->params->get('position', 'jmodule3');
