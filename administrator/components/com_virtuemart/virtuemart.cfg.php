...
define( 'URL', 'http://localhost/ligante3/' );
define( 'SECUREURL', 'http://localhost/ligante3/' );

if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
	define( 'IMAGEURL', SECUREURL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/jxtc_kraftwerks/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/jxtc_kraftwerks/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/jxtc_kraftwerks/' );
...
define('DOWNLOADROOT', 'C:\wamp\www\ligante3/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '149f6511d1efd0de03ba1e05e65a38cb');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
