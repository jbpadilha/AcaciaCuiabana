...
<div class="app-box-header">
	<div class="app-box-header">
		<?php if ($this->params->def( 'show_page_title', 1 )) : ?><h2 style="float:left; width:80%" class="app-box-title"><?php echo $this->task == 'archive' ? $this->escape($this->category->catname.' - '.JText::_('ARCHIVE')) : $this->escape($this->category->catname); ?></h2><?php endif; ?>
