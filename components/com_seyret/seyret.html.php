...
<form action="index.php?option=com_seyret&Itemid=<?php echo $Itemid; ?>" method="post" name="adminForm" class="adminform">
...
<div class="app-box-footer"><div class="app-box-footer"></div></div><br>
<?php
...
?>
<form action="index.php?option=com_seyret&Itemid=<?php echo $Itemid; ?>" enctype="multipart/form-data" method="post" name="adminForm" class="adminform">
