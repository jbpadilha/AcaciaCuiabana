                ...
                <tr>
                    <th align="left">
						<div class="app-box-header">
						  <div class="app-box-header"><div style="float:left;"><h2 class="app-box-title"> <a class="fb_title fbl" href = "<?php echo $statslink;?>"><?php echo stripslashes($fbConfig->board_title); ?> <?php echo _STAT_FORUMSTATS; ?></a></h2></div><div style="float:right;"><img id = "BoxSwitch_frontstats__frontstats_tbody" class = "hideshow" src = "<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt = ""/></div></div>        
					   </div>					                     
                    </th>
                </tr>
            </thead>
