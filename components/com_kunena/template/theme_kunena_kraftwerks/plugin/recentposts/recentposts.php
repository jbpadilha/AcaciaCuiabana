        ...
        <tr>
            <th colspan = "5">
                <div class="app-box-header">
				  <div class="app-box-header"><div style="float:left;"><h2 class="app-box-title"><?php echo _RECENT_RECENT_POSTS; ?></h2></div>	 <div style="float:right;"><img id = "BoxSwitch_recentposts__recentposts_tbody" class = "hideshow" src = "<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt = ""/></div></div>        
			  </div>			  
            </th>
        </tr>
    </thead>
