                    ...
                    <tr>
						...
						<div class="app-box">
						  <div class="app-box-header">
							  <div class="app-box-header"><div style="float:left;"><h2 class="app-box-title">
							  	<?php
                                echo CKunenaLink::GetCategoryLink('listcat', $cat->id, kunena_htmlspecialchars(stripslashes($cat->name)), 'follow', $class='fb_title fbl'); ?>
							 </h2></div><div style="float:right;"><img id = "BoxSwitch_<?php echo $cat->id ; ?>__catid_<?php echo $cat->id ; ?>" class = "hideshow" src = "<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt = ""/></div> </div>        
						  </div>						  						
					</div>						
