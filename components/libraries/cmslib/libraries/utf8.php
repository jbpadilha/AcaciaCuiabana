...
/**
  ...
  * 
  * Modified by Azrul to work with CMSLib
  *
  */
...
class CMSUtf8
{
	...
	function strwidth($str) {
		...
		return $this->strlen($str) - $null + $double;
	}
	...
	function strimwidth($str, $start, $width, $trimmarker = '') {
		...
		$str   = $this->substr($str, $start);
		$width = $width - $this->strwidth($trimmarker);
		...
		for ($i = 0; $i < strlen($str); $i++)
		{
			...
			if ($count > $width) {
				return $this->substr($str, 0, $c - 1) . $trimmarker;
			}
		}	
	}
	...
	function strrpos($haystack, $needle) {
		...
		if ($pos === false) 
			...
			return $this->strlen(substr($haystack, 0, $pos));
	}
	...
	function send_mail($to, $subject, $message , $additional_headers = '', $additional_parameter = '') {
		$subject = $this->encode_mimeheader($subject);
