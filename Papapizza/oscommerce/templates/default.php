...
// <!--//-- check store status --\\-->
  ...
  if ( TAKE_STORE_OFFLINE == 1 ) {
	...
	if ( !$allowed_ip ) {
	  ...
	  osc_redirect(osc_href_link('offline.php', null, 'NONSSL'));
    }
  }
...
<?php
    echo osc_link_object(osc_href_link(FILENAME_DEFAULT), osc_image(DIR_WS_IMAGES . 'store_logo.png', STORE_NAME), 'id="siteLogo"');
?>
