...
heading_title = Pa�ses

table_heading_countries = Pa�ses
...
batch_delete_warning_country_in_use_tax_zone = Aviso : Os seguintes Países não podem ser deletados enquanto tiverem registro de Impostos em suas Regiões .
...
introduction_batch_delete_zones = Verifique a remoção das seguintes Regiães .
batch_delete_warning_zone_in_use_address_book = Aviso : As seguintes Regiães não podem ser deletadas enquanto contiverem Registros nos Livros de Endereços .
batch_delete_warning_zone_in_use_tax_zone = Aviso : As seguintes Regi�es não poderão ser deletadas enquanto tiverem impostos registrados nelas .
