...
operation_title_search = Busca :
operation_new_address_book_entry = Nova Entrada do Livro de Endereços
...
action_heading_new_address_book_entry = Nova Entrada no Livro de Endereços
...
ms_error_email_address = O Email do Cliente tem que ter um mínimo de %s caracteres .
...
ms_error_password = A Senha do Cliente tem que ter um mánimo de %s caracteres .
...
ms_error_suburb = O Bairro dos Clientes tem que ser selecionado .
...
email_subject = Bem Vindo a %s
email_greet_general = %s,
email_greet_mr = Sr. %s,
email_greet_ms = Sra. %s,
email_text = Bem Vindo a %s.

Agora Voce pode participar dos vários Serviços que temos para oferecer. Alguns desses Serviços incluem :

* CARRINHO DE COMPRAS PERMANENTE  -  Todos os produtos que voce adicionou a suas compras permanecerão lá até que Voce os Compre ou os Remova ;
* LIVRO DE ENDERE�OS - Os Produtos poderão ser entregues a qualquer um dos endereços que voce adicionar nele. É perfeito para presentear diretamente.
* HIST�RICO DE COMPRAS - Relação de todas as compras que voce fez em nossa Loja online .
* COMENT�RIOS DE PRODUTOS - Ofereça sua opinião acerca dos produtos que voce conhece aos outros Clientes.

Para resolver qualquer dúvida quanto ao uso dos Serviços mande um Email para %s que faremos o máximo para tirá-las.
